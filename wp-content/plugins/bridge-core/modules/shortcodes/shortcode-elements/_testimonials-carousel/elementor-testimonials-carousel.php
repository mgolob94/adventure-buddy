...
class BridgeCoreElementorTestimonialsCarousel extends \Elementor\Widget_Base{
    public function get_name() {
        return 'bridge_testimonials_carousel';
    }

    public function get_title() {
        return esc_html__( 'Testimonials Carousel', 'bridge-core' );
    }

    public function get_icon() {
        return 'bridge-elementor-custom-icon bridge-elementor-testimonials-carousel';
    }
    ...
    protected function register_controls() {
	    ...
	    $this->add_control(
		    'show_rating',
		    [
			    'label' => esc_html__( 'Show Rating', 'bridge-core' ),
			    'type' => \Elementor\Controls_Manager::SELECT,
			    'options' => bridge_qode_get_yes_no_select_array()
		    ]
	    );
    ...
    protected function render(){
        ...
        echo bridge_core_get_shortcode_template_part('templates/testimonials-carousel', '_testimonials-carousel', '', $params);
    }

}

\Elementor\Plugin::instance()->widgets_manager->register( new BridgeCoreElementorTestimonialsCarousel() );