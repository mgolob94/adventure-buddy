	...
	private function set_actions() { 
        ...
        { 
            ...
            <div class="rm-grid-icon difl">  
                <a href="?page=rm_form_sett_newsletter&rm_form_id=<?php echo intval($_GET['rm_form_id']); ?>&rdrto=<?php echo $rdrto; ?>" class="rm_fd_link">  
        ...
        {   
            ...
            {   
                ...
                if($should_subscribe == 'yes'){
                    ...
                    $service = new RM_NLetter_Service();
                    $form_factory= new RM_Form_Factory_Addon($form_id);
