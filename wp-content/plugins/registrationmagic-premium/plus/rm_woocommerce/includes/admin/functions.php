...
function rm_wc_setting_manage()
{
    ...
    {        
        ...
        if(isset($_POST['rm_wc_enable_rm_account_link']))
            $options->set_value_of('woo_enable_rm_account_link','yes');
        else
            $options->set_value_of('woo_enable_rm_account_link','no');
    ...
    else
    {
        ...
        $data->enable_rm_account_link = $options->get_value_of('woo_enable_rm_account_link');
