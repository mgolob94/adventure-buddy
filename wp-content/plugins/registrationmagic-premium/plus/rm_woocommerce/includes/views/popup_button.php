...
<div class="rm-popup-item dbfl has-custom-handler" id="rm-wc-cart-open" onclick="rmwc_open_cart_panel()" >    
    <?php echo __("Cart",'registrationmagic-addon')."&nbsp&nbsp&nbsp<span>".$data->cart_content_count."</span>"; ?>
</div>
...
function rmwc_open_cart_panel(){
    ...
    jQuery(".rm-floating-page-top").text('<?php _e("Cart","registrationmagic-addon"); ?>');
