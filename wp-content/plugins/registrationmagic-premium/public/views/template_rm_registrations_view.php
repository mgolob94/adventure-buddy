...
<div class="rmagic">
    <div class="rm-user-row dbfl rm-single-tabs rm-single-registrations-tabs" id="rm_my_sub_tab">
                ...
                if ($data->submissions):
                    foreach ($data->submissions as $data_single):
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo add_query_arg( 'submission_id',$data_single->submission_id,get_permalink($sub_page_id)); ?>"><?php echo $data_single->form_name; ?></a></td>
                            ...
                            <td class="rm-submission-download"><a target="_blank" href="<?php echo admin_url('admin-ajax.php?rm_submission_id='.$data_single->submission_id.'&action=rm_print_pdf&rm_sec_nonce='.wp_create_nonce('rm_ajax_secure')); ?>"><i class="material-icons">cloud_download</i></a></td>
