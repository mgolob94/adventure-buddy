...
?>
            <pre class="rm-pre-wrapper-for-script-tags"><script type="text/javascript">
                function rm_validate(e){
                    var required_error= "<?php _e('This field is required','registrationmagic-addon'); ?>";
                    var password_not_match_error=  "<?php _e('password does not match.','registrationmagic-addon'); ?>";       
