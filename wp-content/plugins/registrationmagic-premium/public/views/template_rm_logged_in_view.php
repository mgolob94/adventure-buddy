...
<div class="rm-logged-in-view">
    <div class="rm-logged-in-view-wrap">
        ...
        <div class="rm_display_only_logout"><a href="<?php echo wp_logout_url(get_permalink()); ?>"><?php echo empty($view_options['logout_text']) ? RM_UI_Strings::get('LABEL_LOG_OFF') : $view_options['logout_text']; ?></a></div>
        <?php endif; ?> 
        <?php else: ?>
        ...
        <div class="rm-logged-in-rf">
            ...
            <div class="rm-logged-welcome">
                ...
                <span class="rm-greetings-text"><?php echo empty($view_options['greetings_text']) ? __('Welcome','registrationmagic-addon') : $view_options['greetings_text']; ?></span>
                <?php endif; ?>
        ...
        <div class="rm-logged-in-account-links" style="border-color: #<?php echo $view_options['separator_bar_color']; ?>">
            ...
            <?php if(!empty($view_options['display_account_link'])): ?>
                    <div class="rm_display_account"><a href="<?php echo get_permalink($my_account); ?>"><?php echo empty($view_options['account_link_text']) ? __('My Account', 'registrationmagic-addon')  : $view_options['account_link_text']; ?></a></div>
            <?php endif; ?>

            <!-- Logout -->  
            <?php if(!empty($view_options['display_logout_link'])): ?>
            <div class="rm_display_logout"><a href="<?php echo wp_logout_url(get_permalink()); ?>"><?php echo empty($view_options['logout_text']) ? RM_UI_Strings::get('LABEL_LOG_OFF') : $view_options['logout_text']; ?></a></div>
            <?php endif; ?>    
        </div>
        <?php endif; ?>
    </div>  
