    ...
    <div class="dbfl rm-magic-popup-login">
        ...
        <div id="rm_otp_enter_email">
            ...
            <div class="dbfl rm-login-panel-fields">
                <input type="text" placeholder="<?php _e('Username or Email', 'registrationmagic-addon'); ?>" value="" id="rm_otp_econtact" name="<?php echo wp_generate_password(5, false, false); ?>"
        ...
        <div id="rm_otp_enter_otp" style="display:none" class="rm_otp_after_email rm-mp-animationRight">
            ...
            <div class="dbfl rm-login-panel-fields">
                ...
                <input type="text" value="" placeholder="<?php _e('OTP', 'registrationmagic-addon'); ?>" maxlength="50" name="<?php echo wp_generate_password(5, false, false); ?>" class="difl rm-rounded-corners rm_otp_kcontact" onkeypress="return rm_call_otp(event, '.rm-floating-page-login')"/>
        ...
        <div id="rm_otp_enter_password" style="display:none" class="rm_otp_after_email rm-mp-animationRight">
            ...
            <div class="dbfl rm-login-panel-fields">
                ...
                <input type="password" value="" placeholder="<?php _e('Password', 'registrationmagic-addon'); ?>" maxlength="50" name="<?php echo wp_generate_password(5, false, false); ?>" class="difl rm-rounded-corners rm_otp_kcontact" onkeypress="return rm_call_otp(event, '.rm-floating-page-login')"/>
