        ...
        <div id="rm_otp_login">
            ...
            <div id="rm_otp_enter_email">
                <div class="dbfl rm_otpw_email rm_otpw_field_container">
                    <input type="text" placeholder="<?php _e('Email or Username', 'registrationmagic-addon'); ?>" value="" id="rm_otp_econtact" name="<?php echo wp_generate_password(5, false, false); ?>"
            ...
            <div id="rm_otp_enter_otp" style="display:none" class="rm_otp_after_email rm-otpw-animationRight">
                <span class="rm_otpw_login_back_btn">
                    &larr;&nbsp;<?php _e('Back', 'registrationmagic-addon'); ?>
                </span>
                <div class="dbfl rm_otpw_login_panel_fields rm_otpw_field_container ">

                    <input type="text" value="" placeholder="<?php _e('OTP', 'registrationmagic-addon'); ?>" maxlength="50" name="<?php echo wp_generate_password(5, false, false); ?>" class="rm_otpw_input_box rm_otp_kcontact" onkeypress="return rm_otpw_proceed(event, this)"/>
            ...
            <div id="rm_otp_enter_password" style="display:none" class="rm_otp_after_email rm-otpw-animationRight">
                ...
                <div class="dbfl rm_otpw_login_panel_fields rm_otpw_field_container">
                    ...
                    <input type="password" value="" placeholder="<?php _e('Password', 'registrationmagic-addon'); ?>" maxlength="50" name="<?php echo wp_generate_password(5, false, false); ?>" class="rm_otpw_input_box rm_otp_kcontact" onkeypress="return rm_otpw_proceed(event, this)"/>
...
} else
{
    ...
    ?>
        <a href="<?php echo get_permalink(get_option('rm_option_front_sub_page_id')); ?>"><?php _e('View Submissions', 'registrationmagic-addon'); ?></a>
    </div>
<?php
}