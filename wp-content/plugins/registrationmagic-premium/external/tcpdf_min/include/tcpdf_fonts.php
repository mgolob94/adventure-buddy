...
// ====================================================================================================================
	...
	public static function utf8StrRev($str, &$currentfont, $setbom=false, $forcertl=false, $isunicode=true) {
		return self::utf8StrArrRev(self::UTF8StringToArray($str, $currentfont, $isunicode), $currentfont, $str, $setbom, $forcertl, $isunicode);
	}
	...
	public static function utf8StrArrRev($arr, &$currentfont, $str='', $setbom=false, $forcertl=false, $isunicode=true) {
		return self::arrUTF8ToUTF16BE(self::utf8Bidi($arr, $currentfont, $str, $forcertl, $isunicode), $setbom);
	}
