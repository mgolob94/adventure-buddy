...
<form method="post" id="rm_payapal_field_mananger_form">
    ...
    <div class="operationsbar">
        ...
        <div class="icons">
            <a href="?page=rm_options_payment"><img alt="" src="<?php echo RM_IMG_URL . 'rm-payments.png'; ?>"></a>
        </div>
        <div class="nav">
            <ul>
    ...
    <div class="rm-field-selector">
        ...
        <div class="field-selector-pills">
            <div id="rm_price_fields_tab">
                ...
                <div class="rm_button_like_links"><a href="?page=rm_paypal_field_add&rm_field_type=multisel"><?php echo  RM_UI_Strings::get("P_FIELD_TYPE_MULTISEL") ; ?></a></div>
                <div class="rm_button_like_links"><a href="?page=rm_paypal_field_add&rm_field_type=dropdown"><?php echo  RM_UI_Strings::get("P_FIELD_TYPE_DROPDOWN") ; ?></a></div>  
                <div class="rm_button_like_links"><a href="?page=rm_paypal_field_add&rm_field_type=userdef"><?php echo  RM_UI_Strings::get("P_FIELD_TYPE_USERDEF") ; ?></a></div>  
            </div>
        </div>
    </div>
