    ...
    <div class="rm-formflow-top-bar">
        ...
        <div class="rm-formflow-top-section" style="text-align: right">
            <div class="rm-formflow-top-action rm-formflow-top-action-right" >
                ...
                <span class="rm-formflow-top-right"><a href="<?php echo admin_url( 'admin.php?page=rm_login_sett_manage'); ?>"><?php _e('Form Dashboard', 'registrationmagic-addon'); ?> <i class="material-icons">keyboard_arrow_right</i></a></span>
            </div>
        </div>
    </div>
...
<div class="rmagic">
    ...
    <form method="post" id="rm_field_manager_form">
        ...
        <div class="operationsbar">
            <div class="rmtitle"><?php echo _e('Fields Manager', 'registrationmagic-addon'); ?></div>
            <div class="icons">                
            </div>
            <div class="nav">
                <ul>
                    <?php /* ?><li><a href="#rm-widget-selector" onclick="CallModalBox(this)"><?php echo _e('Add Widget', 'registrationmagic-addon'); ?></a></li><?php */ ?>
                    <li title=""><a href="?page=rm_login_field_view_sett&rdrto=rm_login_field_manage"><?php echo _e('Design', 'registrationmagic-addon'); ?></a></li>
                    <li><a class="thickbox rm_form_preview_btn" id="rm_form_preview_action" href="<?php echo get_permalink(get_option('rm_option_front_login_page_id')); ?>?form_prev=1&form_type=login&amp;TB_iframe=true&amp;width=1216&amp;height=416.1"><?php echo _e('Preview', 'registrationmagic-addon'); ?></a></li>
                    <!--    Forms toggle-->
        ...
        <div class="rm-field-creator rm-login-field-creator">
            <div id="rm_form_page_tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                ...
                <div class="field-selector-pills">
                            ...
                            <ul class="rm-field-container rm_sortable_login_fields ui-sortable">
                                ...
                                <?php foreach($data['form_fields'] as $index=>$field):
                                        if($field['field_label'] === '{{AUTO}}') {
                                            if (strtolower($field['field_type']) == 'username') {
                                                $field['field_label'] = __('Username','registrationmagic-addon');
                                            } elseif (strtolower($field['field_type']) == 'password') {
                                                $field['field_label'] = __('Password','registrationmagic-addon');
                                            }
                                        } ?>    
                                <li id="<?php echo $index ?>">
                                    <div class="rm-custom-field-page-slab">
                                        ...
                                        <div class="rm-slab-buttons">
                                            <a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type='.$field['field_type'].'&field_index='.$index); ?>"><?php echo _e('Edit', 'registrationmagic-addon'); ?></a>
                                            <?php if(in_array(strtolower($field['field_type']),array('username','password'))) : ?>
                                                <a href="javascript:void(0)" class="rm_deactivated"><?php echo _e('Delete', 'registrationmagic-addon'); ?></a>
                                            <?php else : ?>
                                                <a href="<?php echo '?page=rm_login_field_manage&field_index=' . $index. '&rm_action=delete"'; ?>"><?php echo _e('Delete', 'registrationmagic-addon'); ?></a>
                                            <?php endif; ?>    
                                        </div>
                                    </div>
                                </li>
                    ...
                    <?php 
                         $login_label = empty($buttons['login_btn']) ? __('Login','registrationmagic-addon') : $buttons['login_btn'];
                         $btn_align = $buttons['align'];
                         $register_label = empty($buttons['register_btn']) ? __('Register','registrationmagic-addon') : $buttons['register_btn'];
                    ?>
                    <!-- Begin: Submit Field -->
                        <div class="rm-field-submit-field-holder">
                            <div class="rm-field-submit-field">
                                <div class="rm-field-submit-field-btn-container rm-field-btn-align-<?php echo $btn_align; ?>">
                                    &#8203;
                                    <div class="rm-field-next-btn rm_field_btn" id="rm_field_login_button" title="Click to edit button label" contenteditable="true" spellcheck="false"><?php echo htmlentities(stripslashes($login_label)); ?></div>
                                    &#8203;
                                    <div class="rm-field-sub-btn rm_field_btn" id="rm_field_register_button" title="Click to edit button label" contenteditable="true" spellcheck="false"><?php echo htmlentities(stripslashes($register_label)); ?></div>
                                    &#8203;
                                </div>
                                <div class="rm-field-submit-field-options">
                                    ...
                                    <div class="rm-field-submit-field-option-row rm-field-submit-alignment">
                                        <input type="radio" name="rm_field_submit_field_align" value="left" id="rm_field_submit_field_align_left" <?php echo $btn_align=='left' ? 'checked':'' ?>><label for="rm_field_submit_field_align_left"><?php echo _e('Left', 'registrationmagic-addon'); ?></label>
                                         <input type="radio" name="rm_field_submit_field_align" value="center" id="rm_field_submit_field_align_center" <?php echo $btn_align=='center' ? 'checked':'' ?>><label for="rm_field_submit_field_align_center"><?php echo _e('Center', 'registrationmagic-addon'); ?></label>
                                         <input type="radio" name="rm_field_submit_field_align" value="right" id="rm_field_submit_field_align_right"  <?php echo $btn_align=='right' ? 'checked':'' ?>><label for="rm_field_submit_field_align_right"><?php echo _e('Right', 'registrationmagic-addon'); ?></label>
                                    </div>
                                    <div class="rm-field-submit-field-option-row rm-field-submit-ajax-loader" style="visibility: hidden">
                                        <?php echo _e('Updating...', 'registrationmagic-addon'); ?>
                                    </div>
                                </div>
                            </div>
                            <div><input type="checkbox" id="rm_display_register" <?php echo $buttons['display_register']==1 ? 'checked':''; ?>/><?php echo _e('Display "Register" Button', 'registrationmagic-addon'); ?></div>
    ...
    <div id="rm-widget-selector" class="rm-modal-view" style="display:none">
        ...
        <div class="rm-modal-wrap">
            <div class="rm-modal-titlebar">
                <div class="rm-modal-title"><?php echo _e('MagicWidgets', 'registrationmagic-addon'); ?></div>
                ...
                <div class="rmrow">
                    <div class="rm-widget-selector">
                        <ul class="rm-widget-selector-view">
                            <li title="<?php _e("Large size read only text useful for creating custom headings.", 'registrationmagic-addon'); ?>" class="rm_button_like_links">

                                <div class="rm-difl rm-widget-icon rm-widget-heading"><i class="fa fa-header" aria-hidden="true"></i></div>
                                <div class="rm-difl rm-widget-head"><a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type=HTMLH'); ?>"><?php echo _e('Heading', 'registrationmagic-addon'); ?></a>

                                </div>
                            </li>
                            <li title="<?php _e("This is a read only field which can be used to display formatted content inside the form. HTML is supported.", 'registrationmagic-addon'); ?>" class="rm_button_like_links">
                                <div class="rm-difl rm-widget-icon rm-widget-paragraph"><i class="fa fa-paragraph" aria-hidden="true"></i></div> 
                                <div class="rm-difl rm-widget-head"><a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type=HTMLP'); ?>"><?php echo _e('Paragraph', 'registrationmagic-addon'); ?></a>
                                </div>
                            </li>
                            <li title="<?php _e("Divider for separating fields.", 'registrationmagic-addon'); ?>" class="rm_button_like_links">
                                <div class="rm-difl rm-widget-icon rm-widget-divider"><i class="fa fa-arrows-h" aria-hidden="true"></i></div> 
                                <div class="rm-difl rm-widget-head"> <a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type=Divider'); ?>"><?php echo _e('Divider', 'registrationmagic-addon'); ?></a>

                                </div>
                            </li>

                            <li title="<?php _e("Useful for adding space between fields", 'registrationmagic-addon'); ?>" class="rm_button_like_links">
                                <div class="rm-difl rm-widget-icon rm-widget-spacing"><i class="material-icons"></i></div> 
                                <div class="rm-difl rm-widget-head"> <a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type=Spacing'); ?>"><?php echo _e('Spacing', 'registrationmagic-addon'); ?></a>

                                </div>
                            </li>  
                            <li title="<?php _e("Allows you to display richly formatted text inside your form.", 'registrationmagic-addon'); ?>" class="rm_button_like_links">
                                <div class="rm-difl rm-widget-icon rm-widget-richtext"><i class="material-icons"></i></div> 
                                <div class="rm-difl rm-widget-head"><a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type=RichText'); ?>"><?php echo _e('Rich Text', 'registrationmagic-addon'); ?></a>
                            ...
                            <li title="<?php _e("Allows you to display richly formatted text inside your form.", 'registrationmagic-addon'); ?>" class="rm_button_like_links">
                                <div class="rm-difl rm-widget-icon rm-widget-richtext"><i class="material-icons"></i></div> 
                                <div class="rm-difl rm-widget-head"><a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type=Timer'); ?>"><?php echo _e('Timer', 'registrationmagic-addon'); ?></a>
                                </div>
                            </li> 

                            <li class="rm_button_like_links" title="<?php _e("Display link inside your form.", 'registrationmagic-addon'); ?>">

                                <div class="rm-difl rm-widget-icon rm-widget-add-link">
                                    <i class="material-icons"></i>
                                </div>
                                <div class="rm-difl rm-widget-head"><a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type=Link'); ?>"><?php echo _e('Link', 'registrationmagic-addon'); ?></a>

                                </div>
                            </li>

                            <li class="rm_button_like_links" title="<?php _e("Insert a YouTube Video in your form.", 'registrationmagic-addon'); ?>">
                                <div class="rm-difl rm-widget-icon rm-widget-youtube"><i class="fa fa-youtube-play" aria-hidden="true"></i></div> 
                                <div class="rm-difl rm-widget-head"><a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type=YouTubeV'); ?>"><?php echo _e('YouTuve Video', 'registrationmagic-addon'); ?></a>
                                </div>
                            </li> 

                            <li class="rm_button_like_links" title="<?php _e("Display an external webpage inside your form, using HTML iframe.", 'registrationmagic-addon'); ?>">
                                <div class="rm-difl rm-widget-icon rm-widget-iframe-embed"><i class="material-icons"></i></div> 
                                <div class="rm-difl rm-widget-head"><a href="<?php echo admin_url('admin.php?page=rm_login_field_add&field_type=Iframe'); ?>"><?php echo _e('iFrame Embed', 'registrationmagic-addon'); ?></a>
                        ...
                        <div class="dbfl rm-upcoming-widget-head"><?php echo _e('Upcoming MagicWidgets', 'registrationmagic-addon'); ?></div>
                        ...
                        <ul class="rm-widget-selector-view rm-upcoming-widget">
                            ...
                            <li title="" class="rm_button_like_links">
                                ...
                                <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"> <?php echo _e('Image', 'registrationmagic-addon'); ?></a>
                                </div>
                            </li>
                            <li class="rm_button_like_links">
                                <div class="rm-difl rm-widget-icon rm-widget-form-data"><i class="material-icons"></i></div> 
                                <div class="rm-difl rm-widget-head"> <a href="javascript:void(0)"><?php echo _e('Form Meta-Data', 'registrationmagic-addon'); ?></a>
                            ...
                            <li class="rm_button_like_links">
                                ...
                                <div class="rm-difl rm-widget-head"> <a href="javascript:void(0)"><?php echo _e('Form Data Chart', 'registrationmagic-addon'); ?></a>

                                </div>
                            </li>  
                            <li class="rm_button_like_links">
                                <div class="rm-difl rm-widget-icon rm-widget-map"><i class="material-icons"></i></div> 
                                <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"><?php echo _e('Map', 'registrationmagic-addon'); ?></a>
                            ...
                            <li class="rm_button_like_links">
                                ...
                                <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"><?php echo _e('Registration Feed', 'registrationmagic-addon'); ?></a>
