...
<!-----Operationsbar Starts-->
    ...
    <div class="operationsbar">
        ...
        <div class="icons">
        <a href="<?php echo get_admin_url()."admin.php?page=rm_options_autoresponder";?>"><img src="<?php echo RM_IMG_URL . "rm-email-notifications.png"; ?>">
        </a></div>
        <div class="nav">
        <ul>
            ...
            <li onclick="window.history.back()"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("LABEL_BACK"); ?></a></li>
               <li><a href="?page=rm_invitations_manage&rm_queues=true"><?php _e('Active Queues','registrationmagic-addon');  ?></a></li>
            <li><a href="?page=rm_sent_emails_manage"><?php _e('Sent Emails', 'registrationmagic-addon'); ?></a></li>
...
?>
        ...
        <div class="rm-invite-icon"><img src="<?php echo RM_IMG_URL . "rm-hourglass.png"; ?>"></div>
...
<?php
		...
		//$form->addElement(new Element_HTMLL('&#8592; &nbsp; '.__('Cancel','registrationmagic-addon'), '?page=rm_invitations_manage', array('class' => 'cancel')));
