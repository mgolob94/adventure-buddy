...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_TinyMCEWP("<b>" . RM_UI_Strings::get('LABEL_AR_EMAIL_BODY') . "</b>".__('(Mail Merge and HTML Supported)', 'registrationmagic-addon').":", $data->model->form_options->form_email_content, "form_email_content", array('editor_class' => 'rm_TinydMCE', 'editor_height' => '100px'), array("longDesc" => RM_UI_Strings::get('HELP_ADD_FORM_AUTO_RESP_MSG'))));
        $form->addElement(new Element_HTML('</div>'));
...
//$form->addElement(new Element_Button(RM_UI_Strings::get('LABEL_CANCEL'), "button", array("id" => "rm_submit_btn", "class" => "rm_btn", "name" => "cancel", "href" => "?page=rm_form_manage")));
        $form->addElement(new Element_HTMLL('&#8592; &nbsp; '.__('Cancel','registrationmagic-addon'), '?page=rm_form_manage', array('class' => 'cancel')));
