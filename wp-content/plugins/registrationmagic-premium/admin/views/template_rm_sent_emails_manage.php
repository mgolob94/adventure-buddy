            ...
            <div class="sidebar">
                ...
                <div class="sb-filter">
                    <?php echo RM_UI_Strings::get("LABEL_MATCH_FIELD"); ?>
                        ...
                        <div class="filter-row"><input type="button" value="<?php _e('Search', 'registrationmagic-addon'); ?>" onclick="resubmit_search(0)"></div>
                </div>
