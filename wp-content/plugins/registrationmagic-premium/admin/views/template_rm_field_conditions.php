...
$excluded_fields= array('HTMLP','HTMLH','File','Image','Repeatable','Price','Multi-Dropdown',
                       'Time','Divider','Spacing','Shortcode','Rating','Map','Address','RichText','Timer',"Link","YouTubeV","Facebook","Twitter","Instagram","Linked","VKontacte","Skype","SoundCloud");
    ...
    <div class="rm-modal-overlay" style="display:none" onClick="showConditionFormModal()"></div>
        <div class="rm_field_row_setting_wrap rm-select-row-setting rm-field-popup-out">
            <div class="rm-modal-titlebar">
                ...
                <div class="rm-modal-title"><?php _e('Field Conditions','registrationmagic-addon');?></div>
            ...
            <div class="rm-conditional">
                <div class="rm-conditions">
                    <div class="rm-add-field" style="display:none">
                        <a href="javascript:void(0)" onclick="addField()"><?php _e('Add', 'registrationmagic-addon'); ?></a>
                        ...
                        <div style="<?php echo $display; ?>" class="rm-condition" id="rm_condition_<?php echo $field->field_id; ?>" data-field-name="<?php echo ucwords(esc_attr($field->field_label)); ?>"> 
                                ...
                                <div class="rm-field-conditions-wrap">
                                    <div class="rm-field-conditions-title">
                                        ...
                                        <div class="rm-field-conditions-delete" style="display:none;"><a href="javascript:void(0)" onclick="delete_all(<?php echo $field->field_id; ?>)"><?php _e('Delete','registrationmagic-addon'); ?></a> </div>
                                    ...
                                    <div class="rm-fields-conditions-actions">
                                        <div class="rm-box-border rm-box-white-bg rm-box-mb-25 rm-box-ptb">
                                            ...
                                            <ul class="rm-conditions-actions">
                                                <div class="rm-conditions-box-title rm-card-mb-16"><?php _e('Action','registrationmagic-addon'); ?></div>
                                    ...
                                    <div class="rm-field-condition-sec-container">
                                        <div  class="rm-field-condition-container rm-combinator-container rm-box-border rm-box-white-bg rm-box-mb-25 rm-box-ptb" id="rm-container-field-<?php echo $field->field_id; ?>">
                                            <div class="rm-match-condition-row">
                                                    <div class="rm-conditions-box-title rm-card-mb-16"><?php _e('Conditions','registrationmagic-addon'); ?></div>
                                                    <div class="rm-match-condition"><input type="radio" name="combinator" value="OR" <?php echo @$options->conditions['settings']['combinator'] != 'AND' ? 'checked' : '' ?>><label for="rm-match-all-condition" ><?php _e('OR ','registrationmagic-addon'); ?> <span><?php _e('(when one of these conditions are true) ','registrationmagic-addon'); ?></span></label></div>     
                                                    <div class="rm-match-condition"><input  type="radio" name="combinator" value="AND" <?php echo @$options->conditions['settings']['combinator'] == 'AND' ? 'checked' : '' ?>><label for="rm-match-one-condition" ><?php _e('AND ','registrationmagic-addon'); ?> <span><?php _e('(when all of these conditions are true) ','registrationmagic-addon'); ?></span></label></div> 
                                            </div>
                                        <?php
                                                    ...
                                                    <div class="rm-controlling-atr">
                                                        <div class="rminput">
                                                            <?php 
                                                                ...
                                                                $rule_count++;
                                                            ?>
                                                            <input type="<?php echo $field_type;?>" class="<?php echo $calender_class;?><?php echo ($condition['op']=='_blank' || $condition['op']=='_not_blank')?'rm-block-input':''; ?>" value="<?php echo htmlspecialchars($values); ?>" name="values[]" placeholder="Value"  maxlength="50" />
                                                            <?php if($sel_field_type == 'date'):?>
                                                            <script>initialiseCalender('<?php echo $cl_active_class;?>', '<?php echo $date_format;?>', '<?php $values;?>');</script>
                                                            <?php endif;?>
                                                        </div>
                                                    </div>  
                                                        </div>
                                ...
                                <div class="rm-form-builder-modal-footer rm-save-condition-row">
                                        <div class="rm-cancel-row-setting"><a href="javascript:void(0)" onclick="showConditionFormModal()" class="rm-modal-close">← &nbsp;<?php _e('Cancel', 'registrationmagic-addon'); ?></a></div>
                                        <div class="rm-save-row-setting"><input type="submit" value="<?php _e('Save', 'registrationmagic-addon'); ?>" /></div>
                                    </div>
