...
'));
        ...
        $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_FORM_NOTIFS_TO'), "admin_notification", array("yes" => ''),array("id" => "id_rm_admin_notify_cb", "class" => "id_rm_admin_notify_cb" , "value" =>$data->model->form_options->admin_notification,  "onclick" => "hide_show(this)" , "longDesc" => RM_UI_Strings::get('HELP_FOPTIONS_ARESP_ADMIN_NOTIFS'))));
        ...
        $form->addElement(new Element_Radio("<b>" . RM_UI_Strings::get('LABEL_SHOW_PROG_BAR') . "</b>", "display_progress_bar", array('yes'=>RM_UI_Strings::get('LABEL_YES'),'no'=>RM_UI_Strings::get('LABEL_NO'),'default'=>RM_UI_Strings::get('LABEL_DEFAULT')), array("id"=>"id_form_actrl_date_type","value" => $data->model->form_options->display_progress_bar, "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_GEN_PROGRESS_BAR'))));
        $form->addElement(new Element_Radio("<b>" . RM_UI_Strings::get('LABEL_REGISTER_APPROVAL') . "</b>", "user_auto_approval", array('yes'=>RM_UI_Strings::get('LABEL_YES'),'no'=>RM_UI_Strings::get('LABEL_NO'),'default'=>RM_UI_Strings::get('LABEL_DEFAULT')), array("id"=>"id_form_user_auto_approval","value" => $data->model->form_options->user_auto_approval, "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_USER_AUTOAPPROVAL'))));
        $form->addElement(new Element_Radio("<b>" . RM_UI_Strings::get('LABEL_ENABLE_CAPTCHA') . "</b>", "enable_captcha", array('no'=>RM_UI_Strings::get('LABEL_NO'),'default'=>RM_UI_Strings::get('LABEL_DEFAULT')), array("id"=>"id_rm_enable_captcha_cb","value" => $data->model->form_options->enable_captcha, "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ASPM_ENABLE_CAPTCHA'))));
        $form->addElement(new Element_Number(RM_UI_Strings::get('LABEL_SUB_LIMIT_ANTISPAM'), "sub_limit_antispam", array("value" => $data->model->form_options->sub_limit_antispam, "step" => 1, "min" => 0, "longDesc" => RM_UI_Strings::get('LABEL_SUB_LIMIT_ANTISPAM_HELP'))));
