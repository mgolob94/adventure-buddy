...
<div class="rmagic">
 ...
 if($data->error!=null)
        ...
        $form->addElement(new Element_Textbox("<b>" . RM_UI_Strings::get('LABEL_OPT_IN_CB_TEXT') . "</b>", "form_opt_in_text_aw", array("id" => "rm_form_name", "required"=>"required","value" => isset($data->model->form_options->form_opt_in_text_aw)?$data->model->form_options->form_opt_in_text_aw:__('Subscribe for emails','registrationmagic-addon'), "longDesc" => RM_UI_Strings::get('HELP_OPT_IN_CB_TEXT'))));
