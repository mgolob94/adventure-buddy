...
<pre class='rm-pre-wrapper-for-script-tags'><script>
    ...
    if(form_id=='rm_login_form'){
           location.href = '?page=rm_login_analytics';
           return;
    }
    ...
    <div class="operationsbar">
        ...
        <div class="icons">
            <a href="<?php echo get_admin_url() . "admin.php?page=rm_options_manage"; ?>"><img src="<?php echo RM_IMG_URL . "global-settings.png"; ?>">
            </a></div>
        <div class="nav">
            <ul><li onclick="window.history.back()"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("LABEL_BACK"); ?></a></li>
              
                
                <li onclick="jQuery.rm_do_action_with_alert('<?php echo RM_UI_Strings::get('ALERT_STAT_RESET'); ?>', 'rm_form_analytic_dd', 'rm_analytics_reset')"><a class="rm-reset-stats" href="javascript:void(0)"><?php echo RM_UI_Strings::get('LABEL_RESET_STATS'); ?></a></li>
