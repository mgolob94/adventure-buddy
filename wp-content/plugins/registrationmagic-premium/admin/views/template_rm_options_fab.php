...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Checkbox(__('Hide MagicPopup','registrationmagic-addon'), "hide_magic_panel_styler", array("yes" => ''), $data['hide_magic_panel_styler'] == 'yes' ? array("value" => "yes", "longDesc" => RM_UI_Strings::get('HIDE_MAGIC_PANEL_STYLER')) : array("longDesc" => RM_UI_Strings::get('HIDE_MAGIC_PANEL_STYLER'))));
       ...
       $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_SHOW_DETAILS_TAB'), "det_tab", array(1 => ''),array("id" => "id_rm_fabl1", "class" => "fab_l1" , "value" =>$data['show_tabs']['details'],"longDesc" => RM_UI_Strings::get('HELP_SHOW_DETAILS_TAB'))));
        ...
        $form->addElement(new Element_Radio("<b>" . RM_UI_Strings::get('LABEL_FAB_LINK_TYPE') . "</b>", "fab_link_type1", array('page' => __("Page",'registrationmagic-addon'), 'url' => __("URL",'registrationmagic-addon')), array("id" => "rm_", "class" => "fab_link_type1", "onclick" => "hide_show_radio_fab(this);", "value" =>  isset($data['fab_links']['1']['type'])?$data['fab_links']['1']['type']:null, "longDesc" => '')));
       $type=isset($data['fab_links']['1']['type'])?$data['fab_links']['1']['type']:null;
        ...
        $roles=array('everyone'=>__("Everyone",'registrationmagic-addon'),'unreg'=>__("Unregistered",'registrationmagic-addon'),'reg'=>__("All Registered",'registrationmagic-addon'));
        ...
        //Second link starts
         $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_SHOW_FAB_LINK2'), "fab_link2", array("yes" => ''),array("id" => "id_rm_fabl2", "class" => "fab_l2" , "value" =>  isset($data['fab_links']['2']['flag'])?$data['fab_links']['2']['flag']:null,  "onclick" => "hide_show(this)","longDesc"=>RM_UI_Strings::get('HELP_SHO_FAB_LINK'))));
     ...
     //Third link starts
          ...
          $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_SHOW_FAB_LINK3'), "fab_link3", array("yes" => ''),array("id" => "id_rm_fabl3", "class" => "fab_l3" , "value" =>  isset($data['fab_links']['3']['flag'])?$data['fab_links']['3']['flag']:null,  "onclick" => "hide_show(this)","longDesc"=>RM_UI_Strings::get('HELP_SHO_FAB_LINK'))));
        ...
        $form->addElement(new Element_Radio("<b>" . RM_UI_Strings::get('LABEL_FAB_LINK_TYPE') . "</b>", "fab_link_type3", array('page' => __("Page",'registrationmagic-addon'), 'url' => __("URL",'registrationmagic-addon')), array("id" => "rm_", "class" => "fab_link_type3", "onclick" => "hide_show_radio_fab(this);", "value" =>  isset($data['fab_links']['3']['type'])?$data['fab_links']['3']['type']:null, "longDesc" =>'')));
