...
<div class="field-selector-pills">
    ...
    <?php if($data->form->form_type==1 && (!in_array('Username', $primary_fields) || !in_array('UserPassword', $primary_fields))): ?>
        <div class="rm-field-tabs-row rm-dbfl">
            <div class="rm-field-tab-cat"><?php _e('Account Fields', 'registrationmagic-addon'); ?></div>
            <div id="rm_common_fields_tab">
                <?php if(!in_array('Username', $primary_fields)) : ?>
                    <div title="<?php _e('Username', 'registrationmagic-addon'); ?>" class="rm_button_like_links" onclick="add_user_field_to_page('Username')"><a href="javascript:void(0)"><?php _e('Account Username', 'registrationmagic-addon'); ?></a></div> 
                <?php endif; ?>    
                <?php if(!in_array('UserPassword', $primary_fields)) : ?>
                    <div title="<?php _e('User Password', 'registrationmagic-addon'); ?>" class="rm_button_like_links" onclick="add_user_field_to_page('UserPassword')"><a href="javascript:void(0)"><?php _e('Account Password', 'registrationmagic-addon'); ?></a></div> 
                <?php endif; ?>
            </div>
        </div> 
    <?php endif; ?>
    ...
    <div class="rm-field-tabs-row rm-dbfl">
        ...
        <div id="rm_special_fields_tab">
            ...
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_File"); ?>"          class="rm_button_like_links" onclick="add_new_field_to_page('File')">        <a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_FILE"); ?></a></div>
            ...
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Repeatable"); ?>"    class="rm_button_like_links" onclick="add_new_field_to_page('Repeatable')">  <a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_REPEAT"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Map"); ?>"           class="rm_button_like_links" onclick="add_new_field_to_page('Map')">  <a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_MAP"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Address"); ?>"       class="rm_button_like_links" onclick="add_new_field_to_page('Address')">  <a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_ADDRESS"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Phone"); ?>"         class="rm_button_like_links" onclick="add_new_field_to_page('Phone')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_PHONE"); ?></a></div>
            ...
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Language"); ?>"      class="rm_button_like_links" onclick="add_new_field_to_page('Language')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_LANGUAGE"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Bdate"); ?>"         class="rm_button_like_links" onclick="add_new_field_to_page('Bdate')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_BDATE"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Gender"); ?>"        class="rm_button_like_links" onclick="add_new_field_to_page('Gender')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_GENDER"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Time"); ?>"          class="rm_button_like_links" onclick="add_new_field_to_page('Time')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_TIME"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Image"); ?>"         class="rm_button_like_links" onclick="add_new_field_to_page('Image')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_IMAGE"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Image"); ?>"         class="rm_button_like_links" onclick="add_new_field_to_page('ESign')"><a href="javascript:void(0)"><?php _e('ESign','registrationmagic-addon'); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Shortcode"); ?>"     class="rm_button_like_links" onclick="add_new_field_to_page('Shortcode')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_SHORTCODE"); ?></a></div>


            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Multi-Dropdown"); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('Multi-Dropdown')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_MULTI_DROP_DOWN"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Rating"); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('Rating')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_RATING"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_Custom"); ?>"        class="rm_button_like_links" onclick="add_new_field_to_page('Custom')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_CUSTOM"); ?></a></div>
            ...
            <div title="<?php _e('Privacy Policy', 'registrationmagic-addon'); ?>"        class="rm_button_like_links" onclick="add_new_field_to_page('Privacy')"><a href="javascript:void(0)"><?php _e('Privacy Policy', 'registrationmagic-addon'); ?></a></div>
            <?php endif; ?>
            <?php echo do_action('rm_special_field_types_pickers');?>
        </div>
    </div>
    ...
    <div class="rm-field-tabs-row rm-dbfl">
        ...
        <div id="rm_profile_fields_tab">
            ...
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_SecEmail"); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('SecEmail')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("FIELD_TYPE_SEMAIL"); ?></a></div>
            <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_PGAvatar"); ?>" class="rm_button_like_links" <?php if(class_exists('Profile_Magic')) echo 'onclick="add_new_field_to_page(\'PGAvatar\')"'; ?>><a href="javascript:void(0)" <?php if(!class_exists('Profile_Magic')) echo 'class="rm_deactivated"'; ?>><?php echo RM_UI_Strings::get("FIELD_TYPE_PGAVATAR"); ?></a></div>
        </div>
    ...
    <div class="rm-field-tabs-row rm-fields-tab-woo rm-dbfl">
        ...
        <div class="rm-field-tab-cat"> <?php echo __('WooCommerce Fields', 'registrationmagic-addon'); ?></div>
        <div id="rm_wc_fields_tab">
            <div title="<?php echo __('WooCommerce Billing Field', 'registrationmagic-addon'); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('WCBilling')"><a href="javascript:void(0)"><?php echo __('WooCommerce Billing Field', 'registrationmagic-addon'); ?></a></div>
            <div title="<?php echo __('WooCommerce Shipping Field', 'registrationmagic-addon'); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('WCShipping')"><a href="javascript:void(0)"><?php echo __('WooCommerce Shipping Field', 'registrationmagic-addon'); ?></a></div>
            <div title="<?php echo __('Billing Phone Number', 'registrationmagic-addon'); ?>" class="rm_button_like_links" onclick="add_new_field_to_page('WCBillingPhone')"><a href="javascript:void(0)"><?php echo __('Billing Phone Number', 'registrationmagic-addon'); ?></a></div>
        </div>
        <?php else: ?>
        <div class="rm-field-tab-cat"> <?php echo __('WooCommerce Fields (Install and activate WooCommerce to enable these fields)', 'registrationmagic-addon'); ?></div>
        <div id="rm_wc_fields_tab">
            <div title="<?php echo __('WooCommerce Billing Field', 'registrationmagic-addon'); ?>" class="rm_button_like_links"><a href="javascript:void(0)" class="rm_deactivated"><?php echo __('WooCommerce Billing Field', 'registrationmagic-addon'); ?></a></div>
            <div title="<?php echo __('WooCommerce Shipping Field', 'registrationmagic-addon'); ?>" class="rm_button_like_links"><a href="javascript:void(0)" class="rm_deactivated"><?php echo __('WooCommerce Shipping Field', 'registrationmagic-addon'); ?></a></div>
            <div title="<?php echo __('Billing Phone Number', 'registrationmagic-addon'); ?>" class="rm_button_like_links"><a href="javascript:void(0)" class="rm_deactivated"><?php echo __('Billing Phone Number', 'registrationmagic-addon'); ?></a></div>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_YOUTUBE"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('YouTubeV')"><a href="javascript:void(0)"><?php _e('YouTube Video', 'registrationmagic-addon'); ?></a></div> 
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_IFRAME"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('Iframe')"><a href="javascript:void(0)"><?php _e('iFrame Embed', 'registrationmagic-addon'); ?></a></div> 
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_IMAGEV"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('ImageV')"><a href="javascript:void(0)"><?php _e('Image', 'registrationmagic-addon'); ?></a></div>
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_PRICEV"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('PriceV')"><a href="javascript:void(0)"><?php _e('Total Price', 'registrationmagic-addon'); ?></a></div>
    <div title="<?php _e('If you have set form limits, you can display the limit status using this widget', 'registrationmagic-addon'); ?>" class="rm_button_like_links rm-widget-lg" onclick="add_new_widget_to_page('SubCountV')"><a href="javascript:void(0)"><?php _e('Submission Countdown', 'registrationmagic-addon'); ?></a></div>
    <div title="<?php _e('Display a location with marker using GoogleMaps', 'registrationmagic-addon'); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('MapV')"><a href="javascript:void(0)"><?php _e('Map', 'registrationmagic-addon'); ?></a></div>  
    <div title="<?php _e('Display stats about the form using graphs and charts', 'registrationmagic-addon'); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('Form_Chart')"><a href="javascript:void(0)"><?php _e('Form Data Chart', 'registrationmagic-addon'); ?></a></div> 
    <div title="<?php _e('Display various properties of the form', 'registrationmagic-addon'); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('FormData')"> <a href="javascript:void(0)"><?php _e('Form Meta-Data', 'registrationmagic-addon'); ?></a></div>
    <div title="<?php _e('Display latest registrations/ submissions data in your form', 'registrationmagic-addon'); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('Feed')"><a href="javascript:void(0)"><?php echo $data->form->form_type==0 ? __('Submission Feed', 'registrationmagic-addon') : __('Registration Feed', 'registrationmagic-addon'); ?></a></div>
    </div>
    </div>
