...
<form action="" id="rm_form_add_new_form" method="post" class="form-horizontal">
    ...
    <div class="rm-create-new-from">
        <div class="rm-form-name rm-dbfl">
            <div class="rm-form-head rm-difl"><?php _e('Name of your form', 'registrationmagic-addon'); ?></div> 
            <div class="rm-form-name-input rm-dbfl"><input type="text" value="" name="form_name" id="form_name" /></div>
            <div class="rm-form-name-input rm-dbfl"><input type="checkbox" value="" name="rm_form_type" id="rm_form_type" /><label for="rm_form_type"><?php _e('Turn off user registration for this form', 'registrationmagic-addon'); ?></label></div>
        </div>  

        <div class="rm-create-new-from-btn-area">    
            <input type="submit" value="<?php _e("Save and Close", 'registrationmagic-addon') ?>" name="submit" id="rm_submit_btn" onclick="rm_handle_new_form_creation(event)" class="rm_btn btn btn-primary">
        </div>
