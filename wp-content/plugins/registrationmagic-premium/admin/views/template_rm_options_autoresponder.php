...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_USER_NOTIFICATION_FRONT_END'), "user_notification_for_notes", array("yes" => ''), $data['user_notification_for_notes'] == 'yes' ? array("id" => "id_rm_user_notify_cb", "value" => "yes", "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_NOTE_NOTIFS')) : array("id" => "id_rm_user_notify_cb", "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_NOTE_NOTIFS'))));
        ...
        $form->addElement(new Element_Checkbox(RM_UI_Strings::get('LABEL_ENABLE_INCLUDE_PDF'), "admin_notification_includes_pdf", array("yes" => ''), array("id" => "id_rm_include_pdf_cb", "class" => "id_rm_include_pdf_cb" , "value" =>  $data['admin_notification_includes_pdf'],  "longDesc" => RM_UI_Strings::get('HELP_OPTIONS_ARESP_INCLUDE_PDF'))));
     ...
     if ($data['enable_smtp'] == 'yes')
       ...
       if ($data['smtp_auth'] == 'yes')
        ...
        $form->addElement(new Element_HTML('<div class="rmrow rmnoarrow rm-smtp-auth"><div class="rmfield" for="rm_field_value_options_textarea"><label></label></div><div class="rminput"><div class="rm-test-block-container">'
                         . '<div class="rm-test-text"  onclick="jQuery.rm_test_smtp_config()">' . RM_UI_Strings::get('LABEL_TEST_EMAIL') . '</div>'
                         . '<div id="rm_f_loading" style="display:none"></div></div></div>'
                         . '<div class="rm_response" id="rm_smtp_test_response"></div>'
                         . '</div>'));
        ...
        $form->addElement(new Element_HTML('<div class="rmrow rmnoarrow rm_wordpress_default"><div class="rmfield" for="rm_field_value_options_textarea"><label></label></div><div class="rminput"><div class="rm-test-block-container"><div class="rm-test-text" onclick="jQuery.rm_test_wordpress_default_mail()">' . RM_UI_Strings::get('LABEL_TEST_EMAIL') . '</div><div id="rm_f_loading_mail" style="display:none"></div></div></div><div class="rm_response" id="rm_wordpress_default_mail_test_response"></div></div>'));
