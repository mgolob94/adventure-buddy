...
if (!defined('WPINC')) {
    die('Closed');
        ...
        $city_label= empty($data->model->field_options->field_ca_city_label) ? __('City', 'registrationmagic-addon') : $data->model->field_options->field_ca_city_label;
        $state_label= empty($data->model->field_options->field_ca_state_label) ? __('State or Region', 'registrationmagic-addon') : $data->model->field_options->field_ca_state_label;
        $zip_label= empty($data->model->field_options->field_ca_zip_label) ? __('Zip', 'registrationmagic-addon') : $data->model->field_options->field_ca_zip_label;
        $country_label= empty($data->model->field_options->field_ca_country_label) ? __('Country', 'registrationmagic-addon') : $data->model->field_options->field_ca_country_label;
        $address1_label= empty($data->model->field_options->field_ca_address1_label) ? __('Address Line 1', 'registrationmagic-addon') : $data->model->field_options->field_ca_address1_label;
        $lmark_label= empty($data->model->field_options->field_ca_lmark_label) ? __('Landmark', 'registrationmagic-addon') : $data->model->field_options->field_ca_lmark_label;
        $address2_label= empty($data->model->field_options->field_ca_address2_label) ? __('Address Line 2', 'registrationmagic-addon') : $data->model->field_options->field_ca_address2_label;
        ...
        <div id="rm-address-field" >
            <div class="rmrow">
                <div class="rmfield" for="rm_field_is_required_range">
                    <label><b>'.__('Address Field Type', 'registrationmagic-addon').'</b></label>
                </div>
                <div class="rminput">
                    <ul class="rmradio" style="list-style:none;">
                        <li>
                            ...
                            <label for="rm_field_is_ca"><span>'.__('Regular', 'registrationmagic-addon').'</span></label>
                        </li>
                        <li>
                            ...
                            <label for="rm_field_is_ga" class="rm-google-field"><span class="rm-g-field-label">'.__('Autocomplete Powered by', 'registrationmagic-addon').'</span><span class="rm-g-field-img"><img src="'.RM_BASE_URL . "images/rm-google-map-logo.png".'" /></span></label>
                        </li>
                ...
                <div class="rmnote rm-addresstype-note" id="note-ca">
                    ...
                    <div class="rmnotecontent">'.__('This will render a normal address section with a group of input boxes for filling in various address details.', 'registrationmagic-addon').'</div>
                </div>
                
                <div class="rmnote rm-addresstype-note" id="note-ga">
                    <div class="rmprenote"></div>
                    <div class="rmnotecontent">'.__('This will allow users to type in their address in a search box and their address will be fetched automatically using Google Maps and entered into appropriate address input boxes.', 'registrationmagic-addon').'</div>
                </div>
                    ...
                    <div class="rm-address-field-row">
                        <div class="rm-address-field" id="rm-address-field-address">
                            ...
                            <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_address1_req"><input type="checkbox" name="field_ca_address1_req" value="1" '.rm_checkbox_state($address1_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                            </div>
                   ...
                   <div class="rm-address-field-row">
                     ...
                     <label contenteditable="true" spellcheck="false" onkeyup="rm_custom_address_label_changed(this,\'rm_field_ca_address2_label\')">'.$address2_label.'</label>
                           <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_address2_req"><input type="checkbox" name="field_ca_address2_req" value="1" '.rm_checkbox_state($address2_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                            </div>
                     </div>
                   </div>
                   ...
                   <div class="rm-address-field-row">
                     ...
                     <label contenteditable="true" spellcheck="false" onkeyup="rm_custom_address_label_changed(this,\'rm_field_ca_lmark_label\')">'.$lmark_label.'</label>
                           <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_lmark_req"><input type="checkbox" name="field_ca_lmark_req" value="1" '.rm_checkbox_state($lmark_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                            </div>
                     </div>
                   </div>
                    ...
                    <div class="rm-address-field-row rm-address-field-col2" >
                        <div class="rm-address-field" id="rm-address-field-city">
                            ...
                            <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_city_req"><input type="checkbox" name="field_ca_city_req" value="1" '.rm_checkbox_state($city_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                            </div>
                        ...
                        <div class="rm-address-field" id="rm-address-field-states">
                            ...
                            <div id="rm_field_ca_state_all" style="display:none" class="rmstates">
                                ...
                                <div class="rm-ca-actions">
                                    ...
                                    <span id="rm_field_ca_state_req"><input type="checkbox" name="field_ca_state_req" value="1" '.rm_checkbox_state($state_req).'></span>'.__('Required', 'registrationmagic-addon').'
                                </div>
                            </div>    
                            ...
                            <span id="rm_field_ca_state_as_codes" style="display:none"><input name="field_ca_state_codes"   value="1" type="checkbox" '.$state_codes.'/>'.__('Show as codes', 'registrationmagic-addon').'</span>
                    ...
                    <div class="rm-address-field-row rm-address-field-col2">
                        <div class="rm-address-field" id="rm-address-field-country">
                            ...
                            <select style="display:none" class="form-dropdown ca_country" id="rm_field_ca_country_america" data-component="country" tabindex="-1" disabled=""><option>'.__('United States', 'registrationmagic-addon').'</option></select>
                            <select style="display:none" class="form-dropdown ca_country" id="rm_field_ca_country_america_can" name="field_ca_country_america_can" data-component="country" tabindex="-1"><option value="america">'.__('United States', 'registrationmagic-addon').'</option><option value="america_can">'.__('Canada', 'registrationmagic-addon').'</option></select>
                            ...
                            <div class="rm-ca-actions">
                                ...
                                <span '.$hide_search_opt.' id="field_ca_en_country_search"><input type="checkbox"  name="field_ca_en_country_search" value="1" '.rm_checkbox_state($country_search_enabled).'>'.__('Enable Search', 'registrationmagic-addon').'</span>    
                                <span id="rm_field_ca_country_req"><input type="checkbox" name="field_ca_country_req" value="1" '.rm_checkbox_state($country_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                            </div>
                        ...
                        <div class="rm-address-field" id="rm-address-field-zip">
                            ...
                            <div class="rm-ca-actions">
                                ...
                                <span id="rm_field_ca_zip_req"><input type="checkbox" name="field_ca_zip_req" value="1" '.rm_checkbox_state($zip_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                            </div>
                        ...
                        <div class="rm-address-field-state">
                            <ul>
                                <li>  
                                    ...
                                    <label for="rm-addr-textbox-state" onclick="rm_state_type_changed(\'all\')">'.__('All Countries', 'registrationmagic-addon').'</label>
                                
                                </li>
                                <li>
                                          <input id="rm_ca_state_america" type="radio" name="ca_state_type" value="america">    
                                          <label for="rm-addr-select-state" onclick="rm_state_type_changed(\'america\')">'.__('U.S. States', 'registrationmagic-addon').'</label>    
                                </li>
                                <li>
                                          <input id="rm_ca_state_america_can" type="radio" name="ca_state_type" value="america_can">    
                                          <label for="rm-addr-select-state" onclick="rm_state_type_changed(\'america_can\')">'.__('U.S. States & Canadian Provinces', 'registrationmagic-addon').'</label>    
                                </li>
                                <li>
                                          <input id="rm_ca_state_limited" type="radio" name="ca_state_type" value="limited">    
                                          <label for="rm-addr-select-state" onclick="rm_state_type_changed(\'limited\')">'.__('Limited Countries', 'registrationmagic-addon').'</label>    
                                </li>
...
<script>
    ...
    jQuery(document).ready(function(){
       ...
       jQuery("input[name=field_address_type]").on("change", function() {
            rm_address_type_changed(jQuery(this).val());
       });
    });
