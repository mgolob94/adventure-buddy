...
$firstname_label= empty($data->model->field_options->field_wcs_firstname_label) ? __('First Name', 'registrationmagic-addon') : $data->model->field_options->field_wcs_firstname_label;
$lastname_label= empty($data->model->field_options->field_wcs_lastname_label) ? __('Last Name', 'registrationmagic-addon') : $data->model->field_options->field_wcs_lastname_label;
$company_label= empty($data->model->field_options->field_wcs_company_label) ? __('Company', 'registrationmagic-addon') : $data->model->field_options->field_wcs_company_label;
$city_label= empty($data->model->field_options->field_wcs_city_label) ? __('City', 'registrationmagic-addon') : $data->model->field_options->field_wcs_city_label;
$state_label= empty($data->model->field_options->field_wcs_state_label) ? __('State or Region', 'registrationmagic-addon') : $data->model->field_options->field_wcs_state_label;
$zip_label= empty($data->model->field_options->field_wcs_zip_label) ? __('Zip', 'registrationmagic-addon') : $data->model->field_options->field_wcs_zip_label;
$country_label= empty($data->model->field_options->field_wcs_country_label) ? __('Country', 'registrationmagic-addon') : $data->model->field_options->field_wcs_country_label;
$address1_label= empty($data->model->field_options->field_wcs_address1_label) ? __('Street Address 1', 'registrationmagic-addon') : $data->model->field_options->field_wcs_address1_label;
$address2_label= empty($data->model->field_options->field_wcs_address2_label) ? __('Street Address 2', 'registrationmagic-addon') : $data->model->field_options->field_wcs_address2_label;
...
<div id="rm-address-field" >
    <div class="rmrow">
        <div class="rmfield" for="rm_field_is_required_range">
            <label><b>'.__('Shipping Fields', 'registrationmagic-addon').'</b></label>
        </div>
    </div>
            ...
            <div class="rm-address-field-row rm-address-field-col2">
                <div class="rm-address-field" id="rm-address-field-firstname">
                    ...
                    <div class="rm-ca-actions">
                        ...
                        <span id="rm_field_wcs_firstname_req"><input type="checkbox" name="field_wcs_firstname_req" value="1" '.rm_checkbox_state($firstname_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                    </div>
                ...
                <div class="rm-address-field" id="rm-address-field-lastname">
                    ...
                    <div class="rm-ca-actions">
                        ...
                        <span id="rm_field_wcs_lastname_req"><input type="checkbox" name="field_wcs_lastname_req" value="1" '.rm_checkbox_state($lastname_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                    </div>
            ...
            <div class="rm-address-field-row">
                <div class="rm-address-field" id="rm-address-field-company">
                    ...
                    <div class="rm-ca-actions">
                        ...
                        <span id="rm_field_wcs_company_req"><input type="checkbox" name="field_wcs_company_req" value="1" '.rm_checkbox_state($company_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                    </div>
                </div>
            </div>
            ...
            <div class="rm-address-field-row">
                <div class="rm-address-field" id="rm-address-field-address">
                    ...
                    <div class="rm-ca-actions">
                        ...
                        <span id="rm_field_wcs_address1_req"><input type="checkbox" name="field_wcs_address1_req" value="1" '.rm_checkbox_state($address1_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                    </div>
           ...
           <div class="rm-address-field-row">
             ...
             <label contenteditable="true" spellcheck="false" onkeyup="rm_custom_address_label_changed(this,\'rm_field_wcs_address2_label\')">'.$address2_label.'</label>
                   <div class="rm-ca-actions">
                        ...
                        <span id="rm_field_wcs_address2_req"><input type="checkbox" name="field_wcs_address2_req" value="1" '.rm_checkbox_state($address2_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                    </div>
             </div>
           </div>
            ...
            <div class="rm-address-field-row rm-address-field-col2" >
                <div class="rm-address-field" id="rm-address-field-city">
                    ...
                    <div class="rm-ca-actions">
                        ...
                        <span id="rm_field_wcs_city_req"><input type="checkbox" name="field_wcs_city_req" value="1" '.rm_checkbox_state($city_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                    </div>
                ...
                <div class="rm-address-field" id="rm-address-field-states">
                    ...
                    <div id="rm_field_wcs_state_all" style="display:none" class="rmstates">
                        ...
                        <div class="rm-ca-actions">
                            ...
                            <span id="rm_field_wcs_state_req"><input type="checkbox" name="field_wcs_state_req" value="1" '.rm_checkbox_state($state_req).'></span>'.__('Required', 'registrationmagic-addon').'
                        </div>
                    </div>    
                    ...
                    <span id="rm_field_wcs_state_as_codes" style="display:none"><input name="field_wcs_state_codes"   value="1" type="checkbox" '.$state_codes.'/>'.__('Show as codes', 'registrationmagic-addon').'</span>
            ...
            <div class="rm-address-field-row rm-address-field-col2">
                <div class="rm-address-field" id="rm-address-field-country">
                    ...
                    <select style="display:none" class="form-dropdown wcs_country" id="rm_field_wcs_country_america" data-component="country" tabindex="-1" disabled=""><option>'.__('United States', 'registrationmagic-addon').'</option></select>
                    <select style="display:none" class="form-dropdown wcs_country" id="rm_field_wcs_country_america_can" name="field_wcs_country_america_can" data-component="country" tabindex="-1"><option value="america">'.__('United States', 'registrationmagic-addon').'</option><option value="america_can">'.__('Canada', 'registrationmagic-addon').'</option></select>
                    ...
                    <div class="rm-ca-actions">
                        ...
                        <span '.$hide_search_opt.' id="field_wcs_en_country_search"><input type="checkbox"  name="field_wcs_en_country_search" value="1" '.rm_checkbox_state($country_search_enabled).'>'.__('Enable Search', 'registrationmagic-addon').'</span>    
                        <span id="rm_field_wcs_country_req"><input type="checkbox" name="field_wcs_country_req" value="1" '.rm_checkbox_state($country_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                    </div>
                ...
                <div class="rm-address-field" id="rm-address-field-zip">
                    ...
                    <div class="rm-ca-actions">
                        ...
                        <span id="rm_field_wcs_zip_req"><input type="checkbox" name="field_wcs_zip_req" value="1" '.rm_checkbox_state($zip_req).'>'.__('Required', 'registrationmagic-addon').'</span>
                    </div>
