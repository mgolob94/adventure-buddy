...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_HTML('<div class="rmheader">' . __('User Privacy', 'registrationmagic-addon') . '</div>'));
        
        $form->addElement(new Element_HTML('<div class="rmrow"><div class="rmfield"><label>'.__('Delete All Plugin Data', 'registrationmagic-addon').'</label></div><div class="rminput"><ul><li><a href="#rm-confirm-box" class="rm_btn button"  onclick="CallModalBoxEmail(this)">'.__('Delete', 'registrationmagic-addon').'</a></li></ul></div><div class="rmnote"><div class="rmnotecontent">'.__('This will empty all RegistrationMagic tables in your WordPress database returning it to initial default installation state. Frontend published shortcode will remain working as long as RegistrationMagic is active. But you will have to reassign them at appropriate places. Do not close or refresh the page while this process is being executed. After execution, a success message will popup.', 'registrationmagic-addon').'</div></div></div>'));
        ?>
        <div id="rm-confirm-box" class="rm-login-user-details rm-send-email" style="display:none">
            ...
            <div class="rm-modal-wrap">
                ...
                <div class="rm-modal-container rm-confirm-box-container rm-dbfl">
                    <div class="rm-dbfl rm-confirm-box-info"><span class="rm-dbfl" ><?php _e('You are going to delete all RegistrationMagic data from your site. This action cannot be undone. Click OK to proceed.', 'registrationmagic-addon') ?></span></div>
                </div>

                <div class="rm-send-email-footer rm-dbfl">
                    <div class="rm-difl rm-data-cancel-bt"><a href="javascript:void(0)" class="rm-model-cancel">← &nbsp;<?php _e("Cancel", 'registrationmagic-addon'); ?></a></div>
        ...
        <div class="rm_status_failed_model" class="rm-send-email">
            ...
            <div class="rm-modal-wrap-toast">
                <div class="rm-modal-container rm-dbfl">
                    <div class="rm-status-close">×</div>  
                    <div class="rm-dbfl rm-email-box-row"><?php _e('There was a problem and the process did not complete. Please try again later.', 'registrationmagic-addon'); ?></div>
                </div>
            </div>
        </div>
        <?php
