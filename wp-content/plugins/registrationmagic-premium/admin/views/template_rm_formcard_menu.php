...
<div class="rm-formcard-menu" id="fcm_<?php echo $entry->form_id; ?>" data-formid="<?php echo $entry->form_id; ?>" style="visibility:hidden;">
    ...
    <div class="rm-formcard-menu-header"> 
        <span class="rm-formcard-menu-form-name rm_formname_display_span" title="<?php _e('Click to edit form name', 'registrationmagic-addon'); ?>">
            <?php echo htmlentities(stripslashes($entry->form_name)); ?>
        </span>
        <span class="rm_formname_display_span rm_formname_edit_link_span" title="<?php _e('Click to edit form name', 'registrationmagic-addon') ?>">
            <?php _e('Edit', 'registrationmagic-addon') ?>
        </span>
    ...
    <div class="rm-formcard-tabmenu-wrap rm-dbfl">
        <div class="rm-formcard-tabhead-container rm-difl">
            <div class="rm_formcard_tabhead-title"><?php _e('Form', 'registrationmagic-addon'); ?></div>
            <ul>
                <li class="rm_formcard_tabhead rm_active_tabhead" data-tabpanel="#rm_fcm_panel_build"><a href="javascript:void(0)"><?php _e('Build', 'registrationmagic-addon'); ?> </a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_config"><a href="javascript:void(0)"><?php _e('Configure', 'registrationmagic-addon'); ?></a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_integrate"><a href="javascript:void(0)"><?php _e('Integrate', 'registrationmagic-addon'); ?></a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_publish"><a href="javascript:void(0)"><?php _e('Publish', 'registrationmagic-addon'); ?></a></li>
            </ul>
            <div class="rm_formcard_tabhead-title"><?php _e('Submissions', 'registrationmagic-addon'); ?></div>
            <ul>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_manage"><a href="javascript:void(0)"><?php _e('Manage', 'registrationmagic-addon'); ?></a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_analyze"><a href="javascript:void(0)"><?php _e('Analyze', 'registrationmagic-addon'); ?></a></li>
                <li class="rm_formcard_tabhead" data-tabpanel="#rm_fcm_panel_automate"><a href="javascript:void(0)"><?php _e('Automate', 'registrationmagic-addon'); ?></a></li>
            </ul>
        ...
        <div class="rm-formcard-tabpanel-container rm-difl"> 
            <div class="rm-formcard-tabpanel" id="rm_fcm_panel_build">
                ...
                <div class="rm-formcard-tab-item rm-db-link">
                    <a href="?page=rm_form_sett_manage&rm_form_id=<?php echo $entry->form_id; ?>&rdrto=<?php echo $rdrto; ?>#rm-form-build-section" class="rm_fdlink_more"><?php _e('More', 'registrationmagic-addon'); ?></a>
                </div>

                    <div class="rm-formcard-tabpanel-info"><?php _e('Build your form just as you would like it to appear to your site visitors. Add and set up custom fields, labels, buttons, form pages, colors, backgrounds and more.', 'registrationmagic-addon'); ?> 
                    </div>
                </div>
            </div>
            ...
            <div class="rm-formcard-tabpanel" id="rm_fcm_panel_config">
                ...
                <div class="rm-formcard-tab-item rm-db-link">
                    <a href="?page=rm_form_sett_manage&rm_form_id=<?php echo $entry->form_id; ?>&rdrto=<?php echo $rdrto; ?>#rm-general-icon" class="rm_fdlink_more">   
                        <?php _e('More', 'registrationmagic-addon'); ?>
                    </a>

                </div> 
                     
                    <div class="rm-formcard-tabpanel-info"><?php _e('Every form configuration option under the sky! Tweak behavior of your forms to match your registration process.', 'registrationmagic-addon'); ?>  
                    </div>  
            ...
            <div class="rm-formcard-tabpanel" id="rm_fcm_panel_integrate">
                ...
                <?php do_action('rm_extended_apps_formcard_menu', $entry->form_id, $rdrto); ?>
                     ...
                     <div class="rm-formcard-tabpanel-info"><?php _e('Give your form extra chops by connecting it to powerful third party apps, greatly expanding scope of what you can do with your forms.', 'registrationmagic-addon'); ?>
            ...
            <div class="rm-formcard-tabpanel" id="rm_fcm_panel_publish">
                 <div class="rm-formcard-tabpanel-wrap rm-dbfl">
                     <div class="rm-formcard-tab-items" >
                         ...
                         <div class="rm-formcard-tabpanel-info"><?php _e('RegistrationMagic offers you multiple ways to publish your forms and associated data. Choose what suits you best.', 'registrationmagic-addon'); ?></div>
            ...
            <div class="rm-formcard-tabpanel" id="rm_fcm_panel_manage">
                ...
                <div class="rm-formcard-tab-item">
                    <a href="?page=rm_sent_emails_manage&rm_form_id=<?php echo $entry->form_id; ?>" class="rm_fd_link"> 
                     ...
                     <div class="rm-formcard-tab-item rm-db-link">  <a href="?page=rm_form_sett_manage&rm_form_id=<?php echo $entry->form_id; ?>&rdrto=<?php echo $rdrto; ?>#rm-manage-section" class="rm_fd_link"> <?php _e('More', 'registrationmagic-addon'); ?></a></div>
                     
                     <div class="rm-formcard-tabpanel-info"><?php _e('Manage form data collected from users. Advance filters and searches make it both easy and fun to manage large number of submissions.', 'registrationmagic-addon'); ?></div>  
                 </div>
            </div>
            ...
            <div class="rm-formcard-tabpanel" id="rm_fcm_panel_analyze">
                ...
                <div class="rm-formcard-tab-item" id="rm-field-analytics-icon">
                    <a href="?page=rm_analytics_show_field&rm_form_id=<?php echo $entry->form_id; ?>" class="rm_fd_link">   
                       ...
                       <div class="rm-formcard-tab-item rm-db-link">  <a href="?page=rm_form_sett_manage&rm_form_id=<?php echo $entry->form_id; ?>&rdrto=<?php echo $rdrto; ?>#rm-analyze-section" class="rm_fd_link"> <?php _e('More', 'registrationmagic-addon'); ?></a></div>
                    
                    <div class="rm-formcard-tabpanel-info"><?php _e("Analyze the form data using automatically generated metrics and charts. Find meaningful insights essential to fine tuning your form's conversion rate.", 'registrationmagic-addon'); ?>
</div>
            ...
            <div class="rm-formcard-tabpanel" id="rm_fcm_panel_automate">
                ...
                <?php do_action("rm_formcard_menu_action_icon", $entry->form_id, $rdrto); ?>
                     <div class="rm-formcard-tab-item rm-db-link">  <a href="?page=rm_form_sett_manage&rm_form_id=<?php echo $entry->form_id; ?>&rdrto=<?php echo $rdrto; ?>#rm-automate-section" class="rm_fd_link"> <?php _e('More', 'registrationmagic-addon'); ?></a></div>

                     <div class="rm-formcard-tabpanel-info"><?php _e("It works for you, even when you are not working! Create automated tasks and emails which run in the background executing predefined actions.​", 'registrationmagic-addon'); ?>
                     </div>
