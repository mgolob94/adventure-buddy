...
<div class="rmagic">
    ...
    <div class="operationsbar">
        ...
        <div class="icons">
            <a href="?page=rm_options_user"><img alt="" src="<?php echo RM_IMG_URL . 'rm-user-accounts.png'; ?>"></a>
        </div>
        <div class="nav">
            <ul>
                    ...
                    <div class="rm-slab">
                        <div class="rm-slab-grabber">
                            <span class="rm_sortable_handle rm_handle">
                                <img alt="" src="<?php echo RM_BASE_URL . 'images/user_role.png'; ?>">
                            </span>
                        </div>
                        <div class="rm-slab-content">
                            ...
                            <select class="rm-user-role-form-selectbox" style="Display:none" id="<?php echo $role_select_id; ?>" onchange="save_default_form(this,'<?php echo $role; ?>')">
                                  <option value=""><?php _e('None', 'registrationmagic-addon'); ?></option>
                                 <?php
