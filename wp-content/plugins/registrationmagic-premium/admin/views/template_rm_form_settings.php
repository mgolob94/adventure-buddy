...
<!-- Joyride Magic begins -->
    <ol id="rm-form-sett-dashboard-joytips" style="display:none">
        ...
        <li data-id="rm_tour_timewise_stats" data-options="tipLocation:top;nubPosition:hide;tipAdjustmentX:200;tipAdjustmentY:230"><h5><?php _e('Welcome to the Form Dashboard!','registrationmagic-addon'); ?></h5>
            <br/>
            
        <p><?php printf(__('This is where the magic begins &#x1f600;. You will notice, this area is a little barren at the moment. But fret not! As your wonderfully named form, <b> %s </b>starts performing and visitors fill it in, it will soon look busy enough.', 'registrationmagic-addon'),$data->form->get_form_name()); ?></p>
        </li>
        <li data-id="rm_form_dropdown" data-options="tipLocation:bottom;nubPosition:top-right;tipAdjustmentX:-300;tipAdjustmentY:15"><?php _e("Remember - each form will have its own dashboard; accessible by clicking DASHBOARD on its form card. That's how you reached here, right? But once you're here, you do not need to go back to open another form's dashboard. You can just...",'registrationmagic-addon'); ?></li>
        <li data-class="rm-grid-title" data-options="tipAdjustmentY:-15"><?php _e("This of course, is your currently selected form's name. And...",'registrationmagic-addon'); ?></li>
        <li data-class="rm-grid-button" data-options="tipLocation:bottom;tipAdjustmentY:12"><?php _e("You can start adding a new form from right here.",'registrationmagic-addon'); ?></li>
        <li data-class="rm-grid-section" data-options="tipAdjustmentY:-15"><?php _e("This line graph shows how your form is performing. It displays your form views/ visits vs the number of times the form was filled and submitted.",'registrationmagic-addon'); ?></li>
        <li data-id="rm_stat_timerange" data-options="tipAdjustmentY:-15"><?php _e("By default it displays stats from last 30 days. But you can change that easily from this dropdown. You can find more stats in the Analytics section.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-section-icons" data-options="tipAdjustmentY:-10"> <?php _e('This area below contains all the sections within this form.','registrationmagic-addon'); ?></li>
        <li data-id="rm-customfields-icon" data-options="tipAdjustmentX:25"><?php _e('While the <b>Design</b> takes care of the look of your form, <b>Pages and Field</b> decide its content. A form is made up of fillable fields. For example, Name, Email, Address etc. You can create, edit and manage fields from this section.','registrationmagic-addon'); ?></li>       
        <li data-id="rm-design-icon" data-options="tipAdjustmentX:25" ><?php _e("This is where you tweak individual elements of your form to make the overall look match with your website's theme or experiment with different combinations. ",'registrationmagic-addon'); ?></li>

        <li data-id="rm-general-icon"><?php _e('All the form specific tweaks and settings go here. Remember, these are separate from Global Settings which apply to all the forms.','registrationmagic-addon'); ?></li>
        <li data-id="rm-general-settings" data-options="tipAdjustmentX:25"><?php _e('General Settings cover the basic properties of your form, like its Name, Description etc.','registrationmagic-addon'); ?></li>        
        <li data-id="rm-accounts-icon" data-options="tipAdjustmentX:25"><?php _e('Now this is important! This section decides properties of  WordPress User accounts created when a person submits this form.','registrationmagic-addon'); ?></li>
        <li data-id="rm-postsubmit-icon" data-options="tipAdjustmentX:25"><?php _e('Things do not end with submitting the form. You may want to show a success message or a token number or perhaps redirect the user to another page with relevant information. All that and more is configured through this section.','registrationmagic-addon'); ?></li>
        <li data-id="rm-autoresponder-icon" data-options="tipAdjustmentX:25"><?php _e('Automatically send users an email notification with customized content after they have submitted the form.','registrationmagic-addon'); ?></li>
        <li data-id="rm-limits-icon" data-options="tipAdjustmentX:25"><?php _e('Limits allow you to set, well, limits to your form. Once a limit is reached, the form goes to <i>expired</i> state. This will also be visible on the form card. Limits are useful if you have limited submission slots or if registration is only open before a specified date.','registrationmagic-addon'); ?></li>
        <li data-id="rm-access-icon" data-options="tipAdjustmentX:25"><?php _e('Access Control allows you to lock the form and visitor will only be allowed to see it if they meets certain parameters. For example, if you want to allow registrations for people only above 18 years, you can set Date of Birth as access control.','registrationmagic-addon'); ?></li>
        <li data-id="rm-email-templates"  data-options="tipAdjustmentX:25"><?php _e('You can tweak content of the emails being sent out to the users filling this form from here.','registrationmagic-addon'); ?></li>                
        <li data-id="rm-overrides-icon" data-options="tipAdjustmentX:25"><?php _e("<b>Overrides</b> are basically Global Settings which can be over ridden specific to a form. This is useful when you have lots of forms and you want one or some of the forms to have separate configuration compared to others. Remember, not all settings can be over ridden. Only those which can, will appear here.",'registrationmagic-addon'); ?></li>
        
        <li data-id="rm-thirdparty-section"> <?php _e('All form specific integrations can be found in this section. System specific integrations are in Global Settings --> External Integration','registrationmagic-addon'); ?></li>
        <li data-id="rm-mailchimp-icon" data-options="tipAdjustmentX:25"><?php _e("If you are using <b>MailChimp</b>, you can use options here to send your form data to a MailChimp user list. Make sure you configure your MailChimp account in RegistrationMagic -> Global Settings -> External Integrations first. ",'registrationmagic-addon'); ?></li>
        <li data-id="rm-profilegrid-icon" data-options="tipAdjustmentX:25"><?php _e("Add extra bells and whistles to your site by attaching your user registration system to ProfileGrid’s advance user profiles and groups system.",'registrationmagic-addon'); ?></li>
        
        <li data-id="rm-publish-section"><?php _e("Publish forms and user details on frontend using different methods described below.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-shortcode-icon" data-options="tipAdjustmentX:30"><?php _e("Learn how to use shortcode to publish this form on a page or post.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-form-widget-icon" data-options="tipAdjustmentX:30"><?php _e("Learn how to use WordPress theme widgets to publish this form.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-user-area-icon" data-options="tipAdjustmentX:30"><?php _e("Learn how to publish a user account area for registered users on the frontend. ",'registrationmagic-addon'); ?></li>
        <li data-id="rm-magic-popup-icon" data-options="tipAdjustmentX:30"><?php _e("Configure a clickable button with popup on the frontend which allows users to quickly fill forms, login and check their details.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-landing-page-icon" data-options="tipAdjustmentX:30"><?php _e("Learn how to publish this form inside a landing page on the frontend. ",'registrationmagic-addon'); ?></li>
        <li data-id="rm-login-box-icon" data-options="tipAdjustmentX:30"><?php _e("Learn how to publish login form for your users. ",'registrationmagic-addon'); ?></li>
        <li data-id="rm-otp-login-box-icon" data-options="tipAdjustmentX:30"><?php _e("Learn how to allow non-registered users to check their form submissions.  ",'registrationmagic-addon'); ?></li>
        
        <li data-id="rm-manage-section"><?php _e("Manage data collection and user interactions through this form from this section.",'registrationmagic-addon'); ?></li>
        <li data-class="rm-sub-icon-tour" data-options="tipAdjustmentX:30"> <?php _e('You can tweak content of the emails being sent out to the users filling this form from here.','registrationmagic-addon'); ?> <b><?php echo $data->form->get_form_name(); ?></b> go.</li>
        <li data-class="rm-sub-icon-tour-badge" data-options="tipAdjustmentX:-20;tipAdjustmentY:-20"><?php printf(__('See this badge? This tell you the number of time users have filled and submitted this form. Right now there are <b>%d</b> submissions associated with your form <b>%s</b>','registrationmagic-addon'),$data->sub_count,$data->form->get_form_name()); ?></li>
        <li data-id="rm-attachment-icon" data-options="tipAdjustmentX:20"><?php _e('If your form has a file upload field(s), all the attachments go here. Remember, attachments are also visible inside individual submission records in <b>Inbox</b>. But think of this as a bucket where files are stored individually. If you want to download all of them as a zip, this is the place.','registrationmagic-addon'); ?></li>
        <li data-id="rm-outbox-icon" data-options="tipAdjustmentX:20"><?php _e('All the outgoing emails to the users are recorded in this area.','registrationmagic-addon'); ?></li>        
        
        <li data-id="rm-analytics-icon" data-options="tipAdjustmentX:20"><?php _e('<b>Analytics</b>, as the name suggests, collects and displays all the stats related to this form as table, graphs and charts.','registrationmagic-addon'); ?></li>
        <li data-id="rm-field-analytics-icon" data-options="tipAdjustmentX:20"><?php _e('<b>Field Analytics</b>, collects and displays stats related to individual fields inside the form. It can only display meaningful stats from pre-set option field types like <i>dropdown, checkbox or radiobox</i>','registrationmagic-addon'); ?></li>        

        <li data-id="rm-automate-icon" data-options="tipAdjustmentX:20"><?php _e("This is a powerful system which allows you to 'program' the form to do essential workflow tasks for you. We recommend visiting it after you have familiarized yourself with other areas of the form.",'registrationmagic-addon'); ?></li>        
        <li data-id="rm-emailusers-icon" data-options="tipAdjustmentX:25"><?php _e("This section allows you to email all the users who have submitted this form. You'll find this useful for broadcasting announcements and sending bulk updates.",'registrationmagic-addon'); ?></li>

        <li data-id="rm_tour_timewise_stats" data-options="tipLocation:top;nubPosition:hide;tipAdjustmentX:200;tipAdjustmentY:230"><h5><?php _e("We hope you liked what you have seen so far! Let's move on to the two Sidebars.",'registrationmagic-addon'); ?></h5></li>
        
        <li data-id="rm-form-pretoggle" data-options="tipLocation:bottom;nubPosition:top-right;tipAdjustmentX:-330;tipAdjustmentY:12"><?php _e("Click here, and a drop down will appear with list of your forms. And you just have to choose another form from the list. You can try that later. Let's move on...",'registrationmagic-addon'); ?></li>
        <li data-class="rm-permalink-textbox" data-options="tipAdjustmentY:-20"><?php _e("This is form's unique embed code. As the name suggests, you can use this code to embed the form where WordPress shortcode would not work. Like an external webpage. Otherwise, shortcode is always the best way to display the form.",'registrationmagic-addon'); ?></li>
        <li data-class="rm-grid-sidebar-1" data-options="tipAdjustmentY:-18"><?php _e("First one is sort of live update feed for your form.",'registrationmagic-addon'); ?></li>
        <li data-class="rm-grid-sidebar-2" data-options="tipLocation:left;tipAdjustmentX:-10"><?php _e("And the next one is very similar to what you find inside WordPress pages and posts. It provides surface view of the form.",'registrationmagic-addon'); ?></li>
        <li data-class="rm-grid-sidebar-card" data-options="tipLocation:left;tipAdjustmentY:-10"><?php _e("The first block on this sidebar shows submissions feed as users submit the forms. Initially, when there are no submissions, it will simply show \"0\". It'll look a lot different when the submissions start.",'registrationmagic-addon'); ?></li>
        <li data-class="rm-grid-sidebar-row-label" data-options="tipAdjustmentX:-10;tipAdjustmentY:-12"><?php _e("You can view all submissions by clicking on this button.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-attachments-card" data-options="tipAdjustmentY:-24"><?php _e("The second block shows a list of files received through your form. If you do not have a file upload field inside your form, this area will stay empty and you can ignore it.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-view-attachments" data-options="tipAdjustmentX:-10;tipAdjustmentY:-10"><?php _e("You can view all attachments anytime by clicking on this button.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-sc-icon" data-options="tipLocation:top;nubPosition:bottom-right;tipAdjustmentX:-300;tipAdjustmentY:-15"><?php _e("This is the shortcode for this form. As you already know, you need to paste the shortcode where you wish to show the form. You can simply copy the shortcode...",'registrationmagic-addon'); ?></li>
        <li data-id="rm-copy-sc" data-options="tipLocation:top;nubPosition:bottom-right;tipAdjustmentX:-344;tipAdjustmentY:-15"><?php _e("By clicking",'registrationmagic-addon'); ?> <i><?php _e("Copy",'registrationmagic-addon'); ?></i></li>
        <li data-id="rm-sidebar-visibility" data-options="tipLocation:bottom;nubPosition:top-right;tipAdjustmentX:-300;tipAdjustmentY:15"><?php _e("Visiblity of the form defines if the form is visible to all users who have access to form page or if the access control is on. We have already discussed how to open Access Control section. Clicking <i>Edit</i> will take you directly to it.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-delete" data-options="tipLocation:left;tipAdjustmentX:-20;tipAdjustmentY:-30"><?php _e("If you wish to delete this form (with all its contents, stats and submissions), you can do that by clicking Delete. To delete multiple forms, use batch selection checkboxes in Forms Manager.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-pages" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30"><?php _e("Your form can be spread over multiple pages. This number shows the count of pages in your form.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-fields" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30"><?php _e("This shows the number of fields on your form across all pages. For example, a form can have 3 pages with 5 fields on each page. The total field count will be 15.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-add-field"  data-options="tipLocation:top;nubPosition:bottom-right;tipAdjustmentX:-344;tipAdjustmentY:-15"><?php _e("While fields are managed by <b>Pages and Fields</b> section, you can also quickly add a new field by clicking <i>Add</i> here.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-add-submit" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30"><?php _e("This is the label of the submit button of your form. It can be labelled Submit, Register, Send or anything you please. To change it, you can click on <i>Change</i> button on the right side. You can fully customise the look of the Submit button by visiting <b>Design</b> section.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-duplicate" data-options="tipLocation:left;tipAdjustmentX:-15;tipAdjustmentY:-30"><?php _e("You can create a clone of this form by clicking <i>Duplicate</i>. It will have same content, design and field/ pages.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-visitors" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30"><?php _e("This number shows the total number of visitors (or views) of your form during last 30 days.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-submissions" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30"><?php _e("Inbox badge counts the number of times the form has been filled and submitted. Do not confuse this with Users. A single user can submit a form multiple times. You can download all submission records as CSV file by clicking Download Records and open it as spreadsheet inside a desktop program like MS Excel, Apple Numbers etc.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-attachments" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30"><?php _e("As the name suggests, this is total count of files received through this form. The <i>Download All</i> button on right will download all files as single zip.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-conversion" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30"><?php _e("Basically this is number of submissions received versus number of total form views in percentage. If you are using the form on a landing page, this can provide useful insights into performance of the form.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-avgtime" data-options="tipLocation:left;tipAdjustmentX:-45;tipAdjustmentY:-30"><?php _e("This is the average time visitors take to fill out and submit your form.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-reset" data-options="tipLocation:left;tipAdjustmentX:-15;tipAdjustmentY:-30"><?php _e("Clicking <i>Reset</i> will set all stat counters to their initial state. You may want to do this after you have successfully tested your form and are preparing to make it live. It will ensure integrity of the Analytics data.",'registrationmagic-addon'); ?></li>
        <li data-id="rm-sidebar-quick-toggles" data-options="tipLocation:left;tipAdjustmentX:-15;tipAdjustmentY:-10"><?php _e("This block has some useful toggles which allow you to turn options on and off without going into specific sections. Remember, some toggles will not work unless you have set them up first. Like the Autoresponder - you cannot turn it on when you have not yet setup the Autoresponder content inside the <b>Autoresponder</b> section.",'registrationmagic-addon'); ?></li>
        <li data-id="rm_tour_timewise_stats" data-button="Done"  data-options="tipLocation:top;nubPosition:hide;tipAdjustmentX:200;tipAdjustmentY:230"><?php _e("This ends the quick tour of the <b>Form Dashboard</b> area. You can restart the tour anytime in future by clicking on <i>Tour</i> button. As always, if anything does not works as expected, feel free to write to us ",'registrationmagic-addon'); ?><a href="mailto:support@registrationmagic.com"><?php _e("here",'registrationmagic-addon'); ?></a>. <?php _e("Good Luck!",'registrationmagic-addon'); ?></li>
...
<div class="rm-form-configuration-wrapper">
    <div class="rm-grid-top dbfl">
        ...
        <?php
            if (count($data->all_forms) !== 0) {
                ...
                <?php 
                    echo "<option value='rm_login_form'>".__('Login Form','registrationmagic-addon')."</option>";
    ...
    <div class="rm-grid difl"> 
        ...
        <div class="rm-grid-section dbfl" id="rm-general-icon">
            ...
            <?php do_action('rm_form_general_setting_section_tab', $data);?>
        ...
        <div class="rm-grid-section dbfl" id="rm-thirdparty-section">
            ...
            <div class="rm-grid-icon difl" id="rm-profilegrid-icon">  
                <a href="?page=rm_form_sett_profilegrid" class="rm_fd_link">  
                    ...
                    <div class="rm-grid-icon-label dbfl"><?php echo __('ProfileGrid', 'registrationmagic-addon'); ?></div>
                </a>
            </div> 
            <?php else: ?>
            <div class="rm-grid-icon difl" id="rm-profilegrid-icon">  
                ...
                <div class="rm-modal-wrap rm-publish-form-popup">
                    <div class="rm-modal-titlebar rm-new-form-popup-header">
                        <div class="rm-modal-title">
                            <?php _e('User Profiles, Groups, Memberships And Communities','registrationmagic-addon'); ?>               
                        </div>
    ...
    <div class="rm-publish-directory-col rm-difl">
        <div class="rm-section-publish-note"><?php _e('User Profiles, Groups, Memberships And Communities','registrationmagic-addon') ?></div>
        <div class="rm-publish-text"><?php _e('Turn front-end user area into powerful user profile hub. Allow users to edit their profiles including photos. Offer interactive features like groups memberships, real-time messaging and friend lists. Restrict content selectively. ProfileGrid is free and you can get started within minutes.','registrationmagic-addon'); ?></div>
                    <a href="<?php echo $data->pg_install_url; ?>" class="pg-install-now"><?php _e('Install Now','registrationmagic-addon') ?></a>
    ...
    <div class="rm-publish-directory-col rm-difl"></div>
            ...
            <div class="rm-grid-icon difl">  
                <a href="?page=rm_options_eventprime" class="rm_fd_link">  
                    ...
                    <div class="rm-grid-icon-label dbfl"><?php echo __('EventPrime', 'registrationmagic-addon'); ?></div>
                </a>
            </div> 
            <?php else: ?>
            <div class="rm-grid-icon difl">  
            ...
            <div class="rmagic rm-hide-version-number rm-ep-integration">
                <div id="ep_popup_container" class="rm-modal-view" style="display:none">
                    ...
                    <div class="rm-modal-wrap rm-publish-form-popup">
                        <div class="rm-modal-titlebar rm-new-form-popup-header">
                            <div class="rm-modal-title">
                                <?php _e('EventPrime - Event Calendar Management', 'registrationmagic-addon'); ?>               
                            </div>
                            <span class="rm-modal-close">×</span>
                        </div>
                        <div class="rm-modal-container">
                            <div class="rm-directory-container dbfl">
                                <div class="rm-publish-directory-col rm-difl">
                                    ...
                                    <div class="rm-publish-text"><?php _e('Planning to publish events calendar on your site? Use EventPrime to create simple or complex events and manage bookings. EventPrime is free and you can get started within minutes. ', 'registrationmagic-addon'); ?></div>
                                    ...
                                    <a href="<?php echo $data->ep_install_url; ?>" class="pg-install-now"><?php _e('Install Now', 'registrationmagic-addon') ?></a>     
                                </div>
        ...
        <div class="rm-grid-section dbfl" id="rm-publish-section">
            ...
            <div class="rm-grid-icon difl" id="rm-user-area-icon-single-tab">
                <a href="javascript:void(0)" class="rm_fd_link rm_publish_popup_link" data-publish_type="subs_tabs">   
                    <div class="rm-grid-icon-area dbfl">
        ...
        <div class="rm-grid-section dbfl" id="rm-manage-section">
            ...
            <div class="rm-grid-icon difl" id="rm-outbox-icon">
                <a href="?page=rm_sent_emails_manage&rm_form_id=<?php echo $data->form_id; ?>" class="rm_fd_link">   
                    <div class="rm-grid-icon-area dbfl">
    ...
    <div class="rm-grid-sidebar-1 difl">
        ...
        <div class="rm-grid-section-cards rm-attachment-count dbfl"> 
            <?php
            ...
            ?>
            <div class="rm-grid-sidebar-card dbfl <?php echo $attachment->is_new ? '' : "rm-grid-user-new"; ?>">
                    <a href="<?php echo $attachment->image_url ?>" class="fd_att_link">
                        
             
                        
                        <?php echo $attachment->is_new ? "<div class='rm-grid-user-badge'>" . RM_UI_Strings::get('FD_BADGE_NEW') . "!</div>" : ''; ?>
                        <div class="rm-grid-card-profile-image difl">
                            <img src="<?php echo $attachment->image_url ?>">
                        </div>
                        <div class="rm-grid-card-content difl">
                            <div class="dbfl"><?php echo $attachment->name; ?></div>
                            <div class="rm-grid-card-content-subtext dbfl"><?php echo $attachment->date; ?></div>
                        </div>
                    </a>
            </div>
...
?>
            <div class="rm-grid-quick-tasks dbfl">
                <div class="rm-grid-sidebar-row dbfl">
                    <div class="rm-grid-sidebar-row-label difl" id="rm-view-attachments">
                        <a class="<?php echo $data->attachment_count ? '' : 'rm_deactivated'?>" href="?page=rm_attachment_manage&rm_form_id=<?php echo $data->form_id; ?>"><?php echo RM_UI_Strings::get('FD_LABEL_VIEW_ALL'); ?></a>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="rm-grid-section-cards rm-quick-links-box dbfl"> 
              ...
              <div class="rm-grid-section-title dbfl"><?php _e('Quick Links','registrationmagic-addon'); ?></div>
            <div class="rm-grid-sidebar-card dbfl">
                
                <ul class="rm-quick-links">
                    <!--<li><a href="<?php echo admin_url('admin.php?page=rm_options_general'); ?>"><?php _e('Set Form Layout','registrationmagic-addon'); ?></a></li>  -->
                    <li><a href="<?php echo admin_url('admin.php?page=rm_options_user'); ?>"><?php _e('User Approval Method','registrationmagic-addon'); ?></a></li>    
                    <li><a href="<?php echo admin_url('admin.php?page=rm_options_security'); ?>"><?php _e('Configure reCAPTCHA','registrationmagic-addon'); ?></a></li>    
                    <li><a href="<?php echo admin_url('admin.php?page=rm_options_autoresponder'); ?>"><?php _e('Admin Notification Settings','registrationmagic-addon'); ?></a></li>     
                    <li><a href="<?php echo admin_url('admin.php?page=rm_options_payment'); ?>"><?php _e('Payment Settings','registrationmagic-addon'); ?></a></li>     
                    <li><a href="<?php echo admin_url('admin.php?page=rm_options_default_pages'); ?>"><?php _e('Set Default Pages','registrationmagic-addon'); ?></a></li>
                </ul>
    ...
    <div class="rm-grid-sidebar-2 difl">
        ...
        <div class="rm-grid-section dbfl">
            ...
            <div class="rm-grid-sidebar-row dbfl">
                ...
                <div class="rm-grid-sidebar-row-value difl"><?php echo empty($data->form->form_options->form_pages) ? 1 : count($data->form->form_options->form_pages); ?></div>
            </div>
            <div class="rm-grid-sidebar-row dbfl">
                <div class="rm-grid-sidebar-row-icon difl">
        ...
        <div class="rm-grid-section dbfl">
            ...
            <div class="rm-grid-sidebar-row dbfl">
                ...
                <div class="rm-grid-sidebar-row-value difl"><?php echo $data->visitors_count .__(" in last 30 days.",'registrationmagic-addon'); ?></div>
            </div>
            <div class="rm-grid-sidebar-row dbfl">
                <div class="rm-grid-sidebar-row-icon difl">
                ...
                <div class="rm-grid-sidebar-row-value difl"><?php echo $data->sub_count; ?><a href="javascript:void(0)" class="<?php echo $data->sub_count ? '' : 'rm_deactivated'; ?>" onclick="jQuery.rm_do_action('rm_fd_action_form', 'rm_submission_export')"><?php echo RM_UI_Strings::get('FD_DOWNLOAD_REGISTRATIONS'); ?></a></div>
            </div>

            <div class="rm-grid-sidebar-row dbfl">
                <div class="rm-grid-sidebar-row-icon difl">
                    <img src="<?php echo RM_IMG_URL; ?>attachment-dark.png">
                </div>
                <div class="rm-grid-sidebar-row-label difl" id="rm-sidebar-attachments"><?php echo RM_UI_Strings::get('TITLE_ATTACHMENT_PAGE'); ?>:</div>
                <div class="rm-grid-sidebar-row-value difl"><?php echo $data->attachment_count ? : 0; ?><a href="javascript:void(0)" class="<?php echo $data->attachment_count ? '' : 'rm_deactivated'; ?>" onclick="jQuery.rm_do_action('rm_fd_action_form', 'rm_attachment_download_all')"><?php echo RM_UI_Strings::get('LABEL_DOWNLOAD_ALL'); ?></a></div>
            </div>
            ...
            <div class="rm-grid-quick-tasks dbfl">
                <div class="rm-grid-sidebar-row dbfl">
                    <div class="rm-grid-sidebar-row-label difl">
                        <a id="rm-sidebar-reset" href="javascript:void(0)" onclick="jQuery.rm_do_action_with_alert('<?php echo RM_UI_Strings::get('ALERT_STAT_RESET'); ?>', 'rm_fd_action_form', 'rm_analytics_reset')"><?php echo RM_UI_Strings::get('LABEL_RESET'); ?></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="rm-grid-section dbfl">
            ...
            <div class="rm-grid-sidebar-row dbfl">
                <div class="rm-grid-sidebar-row-icon difl">
                    <img src="<?php echo RM_ADDON_IMG_URL; ?>rm-form-auto-approval.png">
                </div>
                <div class="rm-grid-sidebar-row-label difl"><?php echo RM_UI_Strings::get('FD_LABEL_AUTO_APPROVAL'); ?>:</div>
                <div class="rm-grid-sidebar-row-value difl"><div class="rm-grid-sidebar-row-value difl"><div class="switch">
                            <input id="rm-toggle-4" class="rm-toggle rm-toggle-round-flat" onchange="rm_fd_quick_toggle(this, <?php echo $data->form_id; ?>)" name="user_auto_approval" type="checkbox"<?php echo $data->form_options->user_auto_approval === 'yes' ? ' checked' : '' ?>>
                            <label for="rm-toggle-4"></label>
                        </div></div></div>
            </div>
            ...
            <div class="rm-grid-sidebar-row dbfl">
                ...
                <div class="rm-grid-sidebar-row-label difl"><?php echo RM_UI_Strings::get('FD_ISSUE_SUB_TOKEN'); ?>:</div>
                <div class="rm-grid-sidebar-row-value difl"><div class="rm-grid-sidebar-row-value difl"><div class="switch">
                            <input id="rm-toggle-6" class="rm-toggle rm-toggle-round-flat" onchange="rm_fd_quick_toggle(this, <?php echo $data->form_id; ?>)" name="form_is_unique_token" type="checkbox"<?php echo ($data->form_options->form_is_unique_token == 1 || (is_array($data->form_options->form_is_unique_token) && count($data->form_options->form_is_unique_token) == 1)) ? ' checked' : '' ?>>
                            <label for="rm-toggle-6"></label>
                        </div></div></div>
            </div>
            
            <?php if($data->captcha_sitekey && $data->captcha_secret)
                  {
                        $deactivation_class = '';
                        $tooltip = '';
                  }else{
                        $deactivation_class = 'rm_transparent_deactivated';
                        $tooltip = 'title="'.sprintf(RM_UI_Strings::get('FD_TOGGLE_TOOLTIP'),admin_url('admin.php?page=rm_options_security')).'"';
                  }
                
             ?>
            <div <?php echo $tooltip; ?> class="rm-grid-sidebar-row dbfl <?php echo $deactivation_class; ?>">
                <div class="rm-grid-sidebar-row-icon difl">
                    <img src="<?php echo RM_IMG_URL; ?>rm-security.png">
                </div>
                <div class="rm-grid-sidebar-row-label difl"><?php echo RM_UI_Strings::get('NAME_RECAPTCHA'); ?>:</div>
                <div class="rm-grid-sidebar-row-value difl<?php echo ($data->captcha_sitekey && $data->captcha_secret) ?  '' :  ' rm_deactivated'; ?>"><div class="rm-grid-sidebar-row-value difl"><div class="switch">
                            <input id="rm-toggle-7" class="rm-toggle rm-toggle-round-flat" onchange="rm_fd_quick_toggle(this, <?php echo $data->form_id; ?>)" name="enable_captcha" type="checkbox"<?php echo $data->form_options->enable_captcha == 'default' && $data->enable_recaptcha == 'yes' ? ' checked' : '' ?>>
                            <label for="rm-toggle-7"></label>
                        </div></div></div>
            </div>
    ...
    function save_submit_label(){
        ...
        if(label == '')
       {
		...
		jQuery.post(ajaxurl, data, function(response) {
                       ...
                       {
                           alert("<?php _e('Could not Change.Please try again.','registrationmagic-addon'); ?>");
                           location.reload(); 
                       }
