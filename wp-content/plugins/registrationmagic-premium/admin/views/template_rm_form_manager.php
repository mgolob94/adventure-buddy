...
<?php if (($rm_env_requirements & RM_REQ_EXT_CURL) && $data->newsletter_sub_link) { ?>
    <div class="rm-newsletter-banner" id="rm_newsletter_sub"><?php echo $data->newsletter_sub_link; ?><img src="<?php echo RM_IMG_URL . 'close-rm.png'; ?>" onclick="jQuery('#rm_newsletter_sub').hide()"></div>
<?php } ?>
...
<div class="rmagic rm-all-forms">
    ...
    <ol id="rm-form-man-joytips" style="display:none">
        <li data-id="rm-tour-title" data-options="tipLocation:top;nubPosition:hide;tipAdjustmentX:200;tipAdjustmentY:230">
            <h2>
                <?php _e('Welcome to RegistrationMagic', 'registrationmagic-addon'); ?>
            </h2>
            <p><?php _e("RegistrationMagic is a powerful plugin that allows you to build custom registration system on your WordPress site. This is the main landing page - Forms Manager. Click <b>Next</b> to start a quick tour of this page. To stop at anytime, click the close icon on top right.", 'registrationmagic-addon'); ?></p>
        </li>
        <li data-id="rmbar" data-options="tipLocation:bottom"><?php _e('You will see this flat white box on top of different sections inside RegistrationMagic. We call it operations bar. It contains...', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-tour-title" data-options="tipLocation:bottom"><?php _e('The heading of the section you are presently in...', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-ob-icons" data-options="nubPosition:bottom-right;tipAdjustmentX:-330"><?php _e('Quick access icons relevant to the section...', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-ob-sort" data-options="nubPosition:bottom-right;tipAdjustmentX:-320"><?php _e('A filter and sort drop down menu. In this section, it allows you to sort your forms.', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-ob-nav"><?php _e("And a navigation menu with most important functions laid horizontally. Let's look at the Form Manager functions one by one.", 'registrationmagic-addon'); ?></li>
        <li data-id="rm-ob-new"><?php _e('This allows you to create new forms.', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-form-template-tab"><?php _e('Start with a readymade form template.', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-ob-duplicate"><?php _e("This allows you to duplicate one or multiple forms. Form's configuration and fields are also duplicated. Note: This does not duplicates conditional logic applied to the form.", 'registrationmagic-addon'); ?></li>
        <li data-id="rm-ob-delete"><?php _e('This allows you to delete one or multiple forms. All associated form data is deleted.', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-ob-export"><?php _e('This allows you to export all your forms and associated data in a single XML file. Handy if you are reinstalling your site, moving forms to another site or simply backing up your hard work. Note: This does not exports conditional logic applied to the form.', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-ob-import"><?php _e('Import button allows you to import the XML file saved on your computer.', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-card-area"><h3>
                <?php _e('Forms As Cards', 'registrationmagic-addon'); ?>
            </h3>
            <p><?php _e('RegistrationMagic displays all forms as rectangular cards. This is a novel new approach. You will later see that a form card is much more than a symbolic representation of a form. It can show you form related data and stats at a glance.', 'registrationmagic-addon'); ?></p>
        </li>
        <li data-id="rm-card-area"><?php _e("All form cards are displayed as grid, starting from here. You may not need to create more than one registrations form, but it's totally up to you. RegistrationMagic gives a playground to experiment and play to find the best combination for your site. First card slot is reserved for <b>Login Form</b>", 'registrationmagic-addon'); ?></li>
        <li data-class="rm-card-tour"><?php _e('This is a form card. We automatically created it for you to give you a head start.', 'registrationmagic-addon'); ?></li>
        <li data-class="rm-title-tour"><?php _e('This shows title of the form. When you create a new form, you can define its title. You can always change title of this form later, by going into its <b>General Settings</b>', 'registrationmagic-addon'); ?></li>
        <li data-class="rm-checkbox-tour" data-options="tipAdjustmentX:-28;tipAdjustmentY:-5"><?php _e("The checkbox on left side of the title allows you to select multiple forms and perform batch operations. For example, deleting multiple forms. Of course there's nothing stopping you from deleting or duplicating a single form.", 'registrationmagic-addon'); ?></li>
        <li data-class="rm_formcard_menu_icon" data-options="tipAdjustmentX:-25;tipAdjustmentY:-2"><?php _e('Clicking this will open a popup menu allowing you direct access to different sections of this form.', 'registrationmagic-addon'); ?></li>
        <li data-class="unread-box" data-options="tipAdjustmentX:-22;tipAdjustmentY:-5"><?php _e('On top right side of each card is a red number badge. This is the count of total times this form has been filled and submitted on your site by visitors.', 'registrationmagic-addon'); ?></li>
        <li data-class="rm-last-submission"><?php _e("This area displays 3 latest submissions for this form. On new forms it will be empty in the start. Each submission will also show user's Gravatar and time stamp.", 'registrationmagic-addon'); ?></li>
        <li data-class="rm-shortcode-tour" data-options="tipAdjustmentX:50"><?php _e("Now this is important. RegistrationMagic works through shortcodes. That means, to display a form on the site, you must paste its shortcode inside a page, post or a widget (where you want this form to appear). Form shortcodes are always in this format - ", 'registrationmagic-addon'); ?><b>[RM_Form id='x']</b></li>
        <li data-class="rm_def_star_tour" data-options="tipAdjustmentX:-24;tipAdjustmentY:-5"><?php _e('This little star allows you to mark a form as your default registration form.', 'registrationmagic-addon'); ?></li>
        <li data-class="rm-form-settings"><?php _e('Each form has its own dashboard or operations area, that is accessible by clicking the <b>Settings</b> button on the respective form card.', 'registrationmagic-addon'); ?></li>
        <li data-class="rm-form-fields" data-options="tipAdjustmentX:-12"><?php _e('Any form once created is empty. Form fields need to be added manually. This is where <b>Custom Fields Manager</b> comes in. Clicking it will take you to a separate section, where you can add all sorts of fields and pages to your form.', 'registrationmagic-addon'); ?></li>
        <li data-id="rm-tour-title" data-options="tipLocation:top;nubPosition:hide;tipAdjustmentX:200;tipAdjustmentY:230" data-button="Done"><?php printf(__('This ends our tour of Forms Manager. Feel free to explore other sections of RegistrationMagic. We would recommend visiting the form Dashboard first. If anything does not works as expected, please write to us <a href="%s"><u>here</u></a> and we will help you sort it out asap.', 'registrationmagic-addon'),'https://registrationmagic.com/help-support'); ?></li>
    ...
    <form name="rm_form_manager" id="rm_form_manager_operartionbar" class="rm_static_forms" method="post" action="">
        ...
        <div class="operationsbar" id="rmbar">
            ...
            <div class="icons" id="rm-ob-icons">
                <a href="?page=rm_options_manage"><img alt="" src="<?php echo RM_IMG_URL . 'general-settings.png'; ?>"></a>
            </div>
            <div class="nav" id="rm-ob-nav">
                <ul>
                    ...
                    <?php $localized_str_exportall = RM_UI_Strings::get('LABEL_EXPORT') . " <span class='rm-export-count'>(" . RM_UI_Strings::get('LABEL_ALL') . ")</span>";
                    $localized_str_exportselected = RM_UI_Strings::get('LABEL_EXPORT'); ?>
                    ...
                    <li id="rm-ob-demo" class="rm-starter-guide"><a target="_blank" style="display: flex;align-items: center;" href="https://registrationmagic.com/create-wordpress-registration-page-starter-guide/"><?php echo RM_UI_Strings::get('STARTER_GUIDE'); ?><span class="rm-starter-guide-icon material-icons">help_center</span></a></li>
                    <!-- <li id="rm-ob-demo"><a target="_blank" href="http://demo.registrationmagic.com/"><?php //echo RM_UI_Strings::get('LABEL_DEMO');  ?></a></li> -->
                    <?php do_action("rm_form_manager_operation_bar"); ?>
                    <li class="rm-form-toggle" id="rm-ob-sort"><?php _e('Sort Forms', 'registrationmagic-addon'); ?><select onchange="rm_sort_forms(this, '<?php echo $data->curr_page; ?>')">
    ...
    <div class="rmagic-cards" id="rm-card-area">
        ...
        <div id="login_form" class="rmcard">
            ...
            <div class="cardtitle">
                <input class="rm_checkbox" type="checkbox" disabled="disabled"><?php _e('Login Form', 'registrationmagic-addon'); ?></div>
            ...
            <div class="rm-form-links">
                <div class="rm-form-row rm-formcard-dashboard">
                    <a class="rm-form-settings" href="admin.php?page=rm_login_sett_manage">
                        <?php _e('Dashboard', 'registrationmagic-addon'); ?></a>
                </div>   
                <div class="rm-form-row rm-formcard-setup"><a class="rm-form-fields" href="admin.php?page=rm_login_field_manage"><?php _e('Fields', 'registrationmagic-addon'); ?></a></div> 
...
//Check if form is one of the sample forms.
                ...
                ?>
                <?php $form_card_class = apply_filters('rm_form_card_class', 'rmcard', $entry->form_id) ?>
                <div id="<?php echo $entry->form_id; ?>" class="<?php echo trim($form_card_class . " rm-card-tour " . $ex_form_card_class); ?>">
                    ...
                    <div class="cardtitle rm-title-tour">
                        ...
                        <?php // echo $entry->unread_count>0 ? "<div class='unread-box'>".$entry->unread_count."</div>":''; ?>
                    ...
                    <div class="rm-form-links">
                        <div class="rm-form-row rm-formcard-dashboard">
                            <a class="rm-form-settings" href="admin.php?page=rm_form_sett_manage&rm_form_id=<?php echo $entry->form_id; ?>">
                                <?php _e('Dashboard', 'registrationmagic-addon'); ?></a>
                        </div>   
                        <div class="rm-form-row rm-formcard-setup"><a class="rm-form-fields" href="admin.php?page=rm_field_manage&rm_form_id=<?php echo $entry->form_id; ?>"><?php _e('Fields', 'registrationmagic-addon'); ?></a></div> 

                    </div>

        <?php include RM_ADDON_ADMIN_DIR . "views/template_rm_formcard_menu.php"; ?>
...
?>
        ...
        if ($data->sort_by)
            echo'&rm_sortby=' . $data->sort_by;if (!$data->descending)
            echo'&rm_descending=' . $data->descending;
            ?>">«</a></li>
                    <?php
                endif;
        ...
        <div id="fb_sub_footer" class="rm-footer-banner">
            <div class="rm-fb-like-us">
                <a onclick="save_fb_subscribe_action()">
                    <img src="<?php echo RM_IMG_URL . 'fb-thumb-up.png'; ?>"> <?php _e('Like us on Facebook for upgrade notifications, important tips and feature updates.', 'registrationmagic-addon'); ?>
                </a>
            </div>
        </div>
    <?php
    ...
    <div id="rm_add_new_form_popup_template" class="rm-modal-view" <?php echo wp_kses_post($new_form_pop_up_style);?>>
        ...
        <div class="rm_add_new_form_wrap rm-create-new-from rm-form-popup-out">
            <div class="rm-modal-titlebar rm-form-template-popup-header">
                <div class="rm-modal-title">
                    <img src="<?php echo RM_BASE_URL;?>images/rm-logo-icon.svg"><?php _e('Select Your Registration Form Template','registrationmagic-addon'); ?>
                    <span class="rm-form-template-subtitle" style="display:none;"> <?php _e('All templates can be modified after selection. You can add, remove or edit form fields, customize emails and fine tune settings.','registrationmagic-addon'); ?></span>
                </div>
...
<?php include_once RM_ADMIN_DIR . 'views/template_rm_formflow_publish.php'; ?>
    ...
    <div id="rm_embed_code_dialog" style="display:none"><textarea readonly="readonly" id="rm_embed_code" onclick="jQuery(this).focus().select()">&lt;<?php echo admin_url('admin-ajax.php?action=registrationmagic_embedform&rm_form_id='); ?>"&gt;</textarea><div id="rm_embed_warning"><?php echo RM_UI_Strings::get('EMBED_CODE_INFO') ?></div><img class="rm-close" src="<?php echo RM_IMG_URL . 'close-rm.png'; ?>" onclick="jQuery('#rm_embed_code_dialog').fadeOut()"></div>

</div>
    
    <div class="rm-side-banner">
        <div class="rm-sidebanner-image">
            <img src="<?php echo RM_IMG_URL . 'rm-support-banner.svg'; ?>">
        </div>
        <div class="rm-sidebanner-mg-logo">
            <img src="<?php echo RM_IMG_URL . 'mg-logo.png'; ?>">
        </div>       
        <div class="sidebanner-content-wrapper">
            <div class="sidebanner-text-content">
                <div class="sidebanner-text"><?php _e('Something not working?', 'registrationmagic-addon'); ?></div> 
                 <div class="sidebanner-help-text"><?php _e('We want to help!', 'registrationmagic-addon'); ?></div>

                 <p><?php _e('If you face any issues with our plugin, or have questions, we\'re here to help!', 'registrationmagic-addon'); ?></p>
            <!--<div class="rm-side-banner-help-text"><?php _e('Starter Guide', 'registrationmagic-addon'); ?></div>-->
           <!--<div class="rm-side-banner-text"><?php _e('8 minutes read', 'registrationmagic-addon'); ?></div>-->
            <!--<p><?php _e('Recommended read for quick and easy setup', 'registrationmagic-addon'); ?></p>-->
           
            </div>
            <div class="rm-sidebanner-buttons">
              
                <!--<div class="rm-sidebanner-button">
                    <a target="_blank" href="https://registrationmagic.com/create-wordpress-registration-page-starter-guide/"><?php _e('Starter Guide', 'registrationmagic-addon'); ?></a>			
                </div>-->
                <!-- 
                <div class="rm-sidebanner-button">
                    <a href="#rm_add_new_form_popup_template" onclick="CallModalBox(this)"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_ADD_NEW_TEMPLATE'));?></a>
                </div>-->
                <!--<div class="rm-sidebanner-button">
                    <a target="_blank" href="https://metagauss.com/help-and-support/?utm_source=rm_premium_plugin&utm_medium=landing_banner&utm_campaign=support_request"><?php _e('Create Support Request', 'registrationmagic-addon'); ?></a>			
                </div>-->
                 <!-- 
                <div class="rm-sidebanner-button">
                  ...
                  <!-- <div class="rm-sidebanner-button">
                    <a target="_blank" href="https://registrationmagic.com/translate-wordpress-plugins/"><?php _e('Translate', 'registrationmagic-addon'); ?></a>
                </div>-->
                  
                    <div class="rm-sidebanner-button">
                    <a target="_blank" href="admin.php?page=rm_support_forum"> <?php _e('Help & Support', 'registrationmagic-addon'); ?></a>			
                </div>
                 
                  <div class="rm-sidebanner-button">
                    <a target="_blank" href="https://metagauss.com/customization-help/"><?php _e('Request Custom Solution', 'registrationmagic-addon'); ?></a>
                </div>
            </div>
...
<pre class="rm-pre-wrapper-for-script-tags"><script type="text/javascript">
      ...
      function rm_open_dial(form_id) {
          jQuery('textarea#rm_embed_code').html('<iframe class="regmagic_embed" width="500" height="500" src="<?php echo admin_url('admin-ajax.php?action=registrationmagic_embedform&form_id='); ?>' + form_id + '"></iframe>');
        ...
        jQuery.post(ajaxurl, data, function (response) {
            if (response == 0)
            {
               _getEl("progressBar").value = Math.round(100);
                _getEl("status").innerHTML = '<?php _e('Import Successfully Completed', 'registrationmagic-addon'); ?>';
                setTimeout(function(){
    ...
    function start_import(){
        ...
        jQuery.post(ajaxurl, data, function (response) {
            if (response == 0)
            {
                ...
                jQuery("#rm_import_errors").html('');
                jQuery("#rm_import_errors").append("<div class='rm_import_error'><?php _e('Invalid RegistrationMagic template file. Please upload valid template file with XML extension.','registrationmagic-addon') ?></div>");
    ...
    function check_file_extension(obj){
        ...
        if(file && file.type!="text/xml"){
            jQuery("#rm_import_errors").html("<div class='rm_import_error'><?php _e('Invalid RegistrationMagic template file. Please upload valid template file with XML extension.','registrationmagic-addon') ?></div>");
            obj.value='';
        }
    }
    ...
    function uploadFile() {
      ...
      if(!file){
           jQuery("#rm_import_errors").html("<div class='rm_import_error'><?php _e('Please select a file','registrationmagic-addon') ?></div>");
           return;
      }
      jQuery("#rm_import_errors").html('');
    ...
    function progressHandler(event) {
      ...
      _getEl("status").innerHTML = "<?php _e('File upload is in progress...','registrationmagic-addon') ?>";
    }

    function completeHandler(event) {
       var percent = 50;
      _getEl("progressBar").value = Math.round(percent);
      _getEl("status").innerHTML = "<?php _e('Form Import is in progress...','registrationmagic-addon') ?>";
      start_import();
    }

    function errorHandler(event) {
      _getEl("status").innerHTML = "<?php _e('Upload Failed','registrationmagic-addon') ?>";
    }

    function abortHandler(event) {
      _getEl("status").innerHTML = "<?php _e('Upload Aborted','registrationmagic-addon') ?>";
    }     
