...
<!--            <a href="?page=rm_options_payment"><img alt="" src="<?php //echo plugin_dir_url(dirname(dirname(__FILE__))) . 'images/rm-payments.png'; ?>"></a>-->
        ...
        <div class="nav">
            <ul class="rm-automation">
                ...
                <li><a href="javascript:void(0)" onclick="rm_start_joyride()"><?php echo wp_kses_post(RM_Chronos_UI_Strings::get('LABEL_HELP')); ?></a></li>
    ...
    <ul class="rm-field-container" id="rmc_sortable_tasks_list">
        ...
        {$i=0;
            ...
            {
                ?>
                <li id="<?php echo esc_attr($task_data->task_id) ?>">
                    <div class="rm-slab">
                        <div class="rm-slab-grabber">
                            <span class="rmc_task_sortable_handle rm_handle">
                                <img alt="" src="<?php echo esc_url(RM_BASE_URL . 'images/rm-drag.png'); ?>">
                            </span>
                        </div>
                        <div class="rm-slab-content">
                            <input type="checkbox" name="rm_selected[]"  onclick="rm_on_field_selection_change()" value="<?php echo esc_attr($task_data->task_id); ?>">
                            <span><?php echo esc_html($task_data->name); ?></span>
                        </div>
...
<pre class="rm-pre-wrapper-for-script-tags"><script type="text/javascript">
        ...
        jQuery('#rmc_sortable_tasks_list').sortable({
            ...
            update: function (event, ui) {
                ...
                var data = {
                    ...
                    sortable_tasks_nonce: '<?php echo wp_create_nonce('rmc_sortable_tasks_nonce'); ?>'
                };
    ...
    function on_form_change() {
        ...
        window.location = "<?php echo esc_url($data->page_url_base);?>"+"&rm_form_id="+new_form_id;        
    }
