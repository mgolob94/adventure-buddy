...
<div class="rmagic">
    ...
    <div class="rm-task-setting-wrap">
        ...
        <form name="rmc_task_settings_form" id="rmc_task_settings_form" action="" method="post" style="display:none">
            ...
            <input type="radio" name="rm-task-slide" class="rm-slide-radio4 rm-task-slide-radio" id="rm-task-slide-4">
            <div class="rm-task-slide rm-task-slide1">     
                ...
                <div class="rmrow">
                    ...
                    <div class="rminput">
                        <input type="text" name="rmc_task_name" id="rmc_task_name" required value="<?php echo esc_html($data->init_field_config->name); ?>">
                    </div>
                    <div class="rmnote">
                ...
                <div class="rmrow">
                    ...
                    <div class="rminput">
                        <textarea rows="5" name="rmc_task_description" id="rmc_task_description"><?php echo esc_html($data->init_field_config->desc); ?></textarea>
                    </div>
                    <div class="rmnote">
                        <div class="rmprenote"></div>
            ...
            <div class="rm-task-slide rm-task-slide2">
                ...
                <div class="rmrow">
                    ...
                    <div class="rminput">
                        <ul class="rmradio" >
                            <li>
                                <input id="rmc_enable_user_account_rule" class="rmc_control_toggle" type="checkbox" name="rmc_enable_user_account_rule" value="1" <?php echo esc_attr($rule_data['g_user_account_rule']['state']); ?>>
                                <span>  </span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="childfieldsrow" id="rmc_enable_user_account_rule_ctrl_subpanel">
                    <div class="rmrow">
                        ...
                        <div class="rminput">
                            <ul class="rmradio">
                                <li> 
                                    <input id="rm_-0" type="radio" name="rmc_rule_user_account" class="rm_"  required="" value="active" <?php echo esc_attr($rule_data['g_user_account_rule']['active_option_state']); ?>><?php _e('Activated User Accounts','custom-registration-form-builder-with-submission-manager'); ?></li>
                                <li> 
                                    <input id="rm_-1" type="radio" name="rmc_rule_user_account" class="rm_"  required="" value="inactive" <?php echo esc_attr($rule_data['g_user_account_rule']['inactive_option_state']); ?>> <?php _e('Deactivated User accounts','custom-registration-form-builder-with-submission-manager'); ?> </li> 
                            </ul>
                ...
                <div class="rmrow">
                    ...
                    <div class="rminput">
                        <ul class="rmradio" >
                            <li>
                                <input id="rmc_enable_sub_time_rule" class="rmc_control_toggle" type="checkbox" name="rmc_enable_sub_time_rule" value="1" <?php echo esc_attr($rule_data['g_sub_time_rule']['state']); ?>>
                                <span>  </span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="childfieldsrow" id="rmc_enable_sub_time_rule_ctrl_subpanel">
                    <div class="rmrow">
                        ...
                        <div class="rminput">
                            <ul class="rmradio">
                                <li> 
                                    <input id="rmc_enable_sub_time_rule_older_than" type="checkbox" name="rmc_enable_sub_time_rule_older_than" class="rm_" value="1" <?php echo esc_attr($rule_data['g_sub_time_rule']['older_than_state']); ?>> <?php _e('Submissions older than','custom-registration-form-builder-with-submission-manager'); ?>
                                    <input id="rmc_rule_sub_time_older_than_age" type="number" name="rmc_rule_sub_time_older_than_age" class="rm_" step="1" min="0" value="<?php echo esc_attr($rule_data['g_sub_time_rule']['older_than_age']); ?>"> <?php _e('days','custom-registration-form-builder-with-submission-manager'); ?>
                                </li>
                                <li> 
                                    <input id="rmc_enable_sub_time_rule_younger_than" type="checkbox" name="rmc_enable_sub_time_rule_younger_than" class="rm_" value="1" <?php echo esc_attr($rule_data['g_sub_time_rule']['younger_than_state']); ?>> <?php _e('Submissions younger than','custom-registration-form-builder-with-submission-manager'); ?>
                                    <input id="rmc_rule_sub_time_younger_than_age" type="number" name="rmc_rule_sub_time_younger_than_age" class="rm_" step="1" min="0" value="<?php echo esc_attr($rule_data['g_sub_time_rule']['younger_than_age']); ?>"> <?php _e('days','custom-registration-form-builder-with-submission-manager'); ?>
                                </li> 
                            </ul>
                ...
                <div class="rmrow">
                    ...
                    <div class="rminput">
                        <ul class="rmradio">
                            <li>
                                <input id="rmc_enable_field_value_rule" class="rmc_control_toggle" type="checkbox" name="rmc_enable_field_value_rule" value="1" <?php echo esc_attr($rule_data['g_field_val_rule']['state']); ?>>
                                <span>  </span>
                            </li>
                        </ul>
                    </div>
                                ...
                                <li class="appendable_options rm-deletable-options">
                                    <select name="rmc_rule_fv_fids[]">
                                        ...
                                        <?php foreach($data->fields as $field): 
                                                echo '<option value="',esc_attr($field->field_id),'"';
                                                if($field->field_id == $fid)
                                                    echo " selected";
                                                echo '>',esc_html($field->field_label),'</option>';
                                              endforeach; ?>
                                    </select>
                                    <input type="text" placeholder="Values" name="rmc_rule_fv_fvals[]" id="id_placeholder_no" class="" required value="<?php echo esc_attr($rule_data['g_field_val_rule']['rmc_rule_fv_fvals'][$index]); ?>">
                ...
                <div class="rmrow">
                    ...
                    <div class="rminput">
                        <ul class="rmradio" >
                            <li>
                                <input id="rmc_enable_pay_proc_rule" class="rmc_control_toggle" type="checkbox" name="rmc_enable_pay_proc_rule" value="1" <?php echo esc_attr($rule_data['g_pay_proc_rule']['state']); ?>>
                                <span>  </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="rmrow rm_pricefield_checkbox">
                        ...
                        <div class="rminput">
                            <ul class="rmradio">
                                ...
                                <li>
                                    <input id="options_payment-element-1-0" type="checkbox" name="rmc_rule_pay_procs[]" value="<?php echo esc_attr($pproc);?>"
                ...
                <div class="rmrow">
                    ...
                    <div class="rminput">
                        <ul class="rmradio" >
                            <li>
                                <input id="rmc_enable_pay_status_rule" class="rmc_control_toggle" type="checkbox" name="rmc_enable_pay_status_rule" value="1" <?php echo esc_attr($rule_data['g_pay_status_rule']['state']); ?>>
                                <span>  </span>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="rminput">
                            <ul class="rmradio">
                                ...
                                <li>
                                    ...
                                    ?>            
                                    <input id="options_payment-element-1-0" type="checkbox" name="rmc_rule_pay_status[]" value="completed" <?php echo esc_attr($temp_state); ?>>
                                ...
                                <li>
                                    ...
                                    ?>
                                    <input id="options_payment-element-1-1" type="checkbox" name="rmc_rule_pay_status[]" value="pending" <?php echo esc_attr($temp_state); ?>>
                                ...
                                <li>
                                    ...
                                    ?>
                                    <input id="options_payment-element-1-2" type="checkbox" name="rmc_rule_pay_status[]" value="canceled" <?php echo esc_attr($temp_state); ?>>
            ...
            <div class="rm-task-slide rm-task-slide3">
                ...
                <div class="rmrow">
                    <div class="rmfield">
                        <label><b><?php _e('Assign User Role','custom-registration-form-builder-with-submission-manager'); ?></b></label>
                    </div>
                    <div class="rminput">
                        ...
                        <?php
                            ...
                            foreach($roles as $role_key => $role_val) {
                                ...
                                if(in_array($role_key, $action_data['g_assign_user_role_action']['roles']))
                                    echo '<div class="rm-wp-role-selector rm-d-flex rm-box-center"><input type="checkbox" id="'.esc_attr($role_key).'" value="'.esc_attr($role_key).'" '.esc_html($tag_attr).' checked="checked">';
                                else
                                    echo '<div class="rm-wp-role-selector rm-d-flex rm-box-center"><input type="checkbox" id="'.esc_attr($role_key).'" value="'.esc_attr($role_key).'" '.esc_html($tag_attr).'>';
                                echo '<label for="'.esc_attr($role_key).'"> '.esc_html($role_val).'</label></div>';
                            }
                        ?>
                        </div>
                    </div>
                        ...
                        <ul class="rmradio">
                            <li>
                                <?php if(defined('REGMAGIC_ADDON')) { ?>
                                    <input id="rmc_enable_send_mail_action" class="rmc_control_toggle" type="checkbox" name="rmc_enable_send_mail_action" value="1" <?php echo esc_attr($action_data['g_send_email_action']['state']);?>>
                                <?php } else { ?>
                ...
                <div class="childfieldsrow" id="rmc_enable_send_mail_action_ctrl_subpanel">                
                    <div class="rmrow">
                        ...
                        <div class="rminput">
                            <input type="text" name="rmc_action_send_mail_sub" required="" id="rmc_action_send_mail_sub" value="<?php echo esc_attr($action_data['g_send_email_action']['sub']);?>">
                        </div>
                        <div class="rmnote">
                            <div class="rmprenote"></div>
            ...
            <div class="rm-task-slide rm-task-slide4">
                
                <div class="rmrow">
                    <div class="rmfield" for="">
                        <label><b><?php _e('Automation Type','custom-registration-form-builder-with-submission-manager'); ?></b></label>
                    </div>
                    <?php $automation_type = array("manual"=>"Manual",
                                                      "automatic"=>"Scheduled");?>
                    <div class="rminput">
                        <select id="rmc_task_type" class="widefat" name="rmc_task_type">
                            <?php 
                                foreach($automation_type as $key => $type):
                                    if(isset($data->init_field_config->meta['rmc_task_type']) && $data->init_field_config->meta['rmc_task_type'] == $key ):
                    ...
                    <div class="rmnote">
                        <div class="rmprenote"></div>
                        <div class="rmnotecontent"><?php _e("Choose how you wish to run this automation task. Manual tasks can be executed through Automation Tasks list view.",'custom-registration-form-builder-with-submission-manager') ?></div>
                    </div>
                </div>
                <?php 
                $automatic_active = "display:none;";
                if(isset($data->init_field_config->meta['rmc_task_type']) && $data->init_field_config->meta['rmc_task_type'] == 'automatic'){
                 $automatic_active = "display:block;";   
                }
                ?>
                <div class="childfieldsrow" id="rmc_enable_crons" style="<?php echo esc_attr($automatic_active); ?>">  
                    <div class="rmrow">
                        <div class="rmfield" for="rmc_task_name">
                            <label><b><?php _e('Starts On','custom-registration-form-builder-with-submission-manager'); ?></b><sup class="required">* </sup></label>
                        </div>
                        <div class="rminput">
                            <input type="datetime-local" name="rmc_task_first_execution" id="rmc_task_first_execution" required value="<?php if(isset($data->init_field_config->meta['rmc_task_first_execution']) && !empty($data->init_field_config->meta['rmc_task_first_execution'])) { echo str_replace(' ', '', RM_Utilities::localize_time($data->init_field_config->meta['rmc_task_first_execution'], 'Y-m-d\T\ H:i', false, true)); } ?>">
                        </div>
                        <div class="rmnote">
                            <div class="rmprenote"></div>
                            <div class="rmnotecontent"><?php _e('Set the first execution date and time for this automation task. Schedule will be set based on this date and time.','custom-registration-form-builder-with-submission-manager'); ?> </div>
                        </div>
                    </div>
                    <div class="rmrow">
                        <div class="rmfield" for="rmc_task_name">
                            <label><b><?php _e('Schedule','custom-registration-form-builder-with-submission-manager'); ?></b><sup class="required">* </sup></label>
                        </div>
                        <?php $event_schedule = array("hourly"=>"Once Hourly (hourly)",
                                                      "twicedaily"=>"Twice Daily (twice daily)",
                                                      "daily"=>"Once Daily (daily)",
                                                      "weekly"=>"Once Weekly (weekly)");?>
                        <div class="rminput">
                            <select id="rm-task-schedule" class="widefat" name="rmc_task_schedule">
                                <?php
                                foreach($event_schedule as $key => $schedule):
                                    if(isset($data->init_field_config->meta['rmc_task_schedule']) && $data->init_field_config->meta['rmc_task_schedule'] == $key ):
                                        echo '<option value="'.$key.'" selected>'.$schedule.'</option>';
                                    else:
                                        echo '<option value="'.$key.'">'.$schedule.'</option>';
                                    endif;
                                endforeach;
                                ?>
                        </select>
                        ...
                        <div class="rmnote">
                            <div class="rmprenote"></div>
                            <div class="rmnotecontent"><?php _e('Choose how often you wish to run this automation task.','custom-registration-form-builder-with-submission-manager'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="buttonarea rm-task-setting-footer">              
                <div class="rm-previous rm-control">
                    <label for="rm-task-slide-1" class="rm-numb0"><a href="<?php echo get_admin_url(null,'admin.php?page=rm_ex_chronos_manage_tasks&rm_form_id='.$data->form_id); ?>">&larr; &nbsp; Back</a></label>
                    ...
                    <label for="rm-task-slide-4" class="rm-numb4">&larr; &nbsp; <?php _e('Previous','custom-registration-form-builder-with-submission-manager'); ?></label>
                </div>           
                <div class="rm-next rm-control">
                    ...
                    <label for="rm-task-slide-4" class="rm-numb4" onclick="rmc_validate_task_form('action_config')"><?php _e('Next','custom-registration-form-builder-with-submission-manager'); ?></label>
                    <label for="rm-task-slide-5" class="rm-numb5" onclick="rmc_validate_task_form('cron_config')"><?php _e('Save','custom-registration-form-builder-with-submission-manager'); ?></label>
                </div>            
            </div> 
        </form>
    </div> 
