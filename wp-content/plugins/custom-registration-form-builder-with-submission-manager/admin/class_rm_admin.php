...
class RM_Admin {
   ...
   version="1.1"><metadata
    ...
    public function enqueue_styles($hook) {
        ...
        if($hook == 'toplevel_page_rm_dashboard_widget_dashboard' || $hook =='admin_page_rm_dashboard_widget_dashboard' || $hook == 'registrationmagic_page_rm_dashboard_widget_dashboard') {
        ...
        if (!class_exists("AAM")){
            ...
            if(!RM_Utilities::fatal_errors()) {
                ...
                if (current_user_can("top_admin_show")){
                    ...
                    add_submenu_page("", RM_UI_Strings::get('ADMIN_MENU_SUPPORT'), RM_UI_Strings::get('ADMIN_MENU_SUPPORT'), "top_admin_show", "rm_support_forum", array($this->get_controller(), 'run'));
    ...
    public function post_feedback(){
        ...
        $msg= isset($_POST['msg']) ? wp_kses_post($_POST['msg']) : '';
    ...
    public function upload_template(){
       ...
       if($_FILES && current_user_can("manage_options") && check_ajax_referer( 'rm_admin_upload_template', 'rm_ajaxnonce' )){
               ...
               echo wp_kses_post(json_encode(array('success'=>$status)));
...

        {
            ...
            echo wp_kses_post(json_encode(array('success'=>false)));
