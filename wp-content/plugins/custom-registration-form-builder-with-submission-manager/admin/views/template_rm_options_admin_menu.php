...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        foreach ( $menu_items as $menu_item_title => $menu_item_slug ) {
            if ($menu_item_slug[0] == "rm_form_manage_cstatus" && !class_exists('Registration_Magic_Addon')) {
    ...
    foreach ( $roles as $role_slug => $role ) {
        ...
        if ($role['name'] ==  "Administrator"){
            ...
            if (in_array($role_slug, $access)){
                $code .= "<input type='checkbox' id='". esc_html($slug) ."_". esc_html($role['name']) ."'  class='rm-admin-checkbox' name='". esc_html($slug) ."_". esc_html($role['name']) ."' value='". esc_html($role['name']) ."' checked>";
            }else{
                $code .= "<input type='checkbox' id='". esc_html($slug) ."_". esc_html($role['name']) ."'  class='rm-admin-checkbox' name='". esc_html($slug) ."_". esc_html($role['name']) ."' value='". esc_html($role['name']) ."'>";
            }
...
jQuery(function($) {
    ...
    admin_form.click(function(e) {
        ...
        var myInput2 = document.getElementById("rm_options_manage");
        var myInput3 = document.getElementById("rm_user_role_manage_title");
        var myInput4 = document.getElementById("rm_paypal_field_manage_title");
        var myInput5 = document.getElementById("rm_dashboard_widget_dashboard_title");
        var myInput6 = document.getElementById("rm_submission_manage_title");
        var myInput7 = document.getElementById("rm_sent_emails_manage_title");
        var myInput8 = document.getElementById("rm_attachment_manage_title");
        var myInput9 = document.getElementById("rm_payments_manage_title");
        var myInput10 = document.getElementById("rm_user_manage_title");
        var myInput11 = document.getElementById("rm_analytics_show_form_title");
        var myInput12 = document.getElementById("rm_analytics_show_field_title");
        var myInput13 = document.getElementById("rm_reports_dashboard_title");
        var myInput14 = document.getElementById("rm_form_manage_cstatus");
        var myInput15 = document.getElementById("rm_ex_chronos_manage_tasks_title");
        var myInput16 = document.getElementById("rm_invitations_manage_title");
