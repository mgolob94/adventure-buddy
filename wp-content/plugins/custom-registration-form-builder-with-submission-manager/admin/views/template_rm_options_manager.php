...
<div class="rmagic">
    ...
    <div class="rm-global-settings">
        ...
        <div class ="rmnotice" style="min-height:45px;">
                    ...
                    $numHiddenMenus = $gopts->get_value_of('num_hidden_menus');
                    ...
                    if ($numHiddenMenus > 0){
                        echo "<br>";
                        echo "<br>";
                        echo __("$numHiddenMenus menu items have been hidden from the admin menu based on your settings. You can restore them from 'Admin Menu' section below.",'custom-registration-form-builder-with-submission-manager');
                    }
                    ?>
        ...
        <div class="settings-icon-area">
            <a href="admin.php?page=rm_options_general">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>general-settings.png">
            ...
            <a href="admin.php?page=rm_options_fab">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>svg/fab-options.svg">
                    <div class="rm-settings-description">
            ...
            <a href="admin.php?page=rm_options_security">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>rm-security.png">
                    <div class="rm-settings-description">
            ...
            <a href="admin.php?page=rm_options_user">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>rm-user-accounts.png">
                    <div class="rm-settings-description">
            ...
            <a href="admin.php?page=rm_options_autoresponder">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>rm-email-notifications.png">
                    <div class="rm-settings-description">
            ...
            <a href="admin.php?page=rm_options_thirdparty">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>rm-third-party.png">
                    <div class="rm-settings-description">
            ...
            <a href="admin.php?page=rm_options_payment">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>rm-payments.png">
                    <div class="rm-settings-description">
            ...
            <a href="admin.php?page=rm_options_default_pages">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>rm-default-pages.png">
                    <div class="rm-settings-description">
            ...
            <a href="admin.php?page=rm_options_user_privacy">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>user-privacy.png">
                    <div class="rm-settings-description">
            ...
            <a href="admin.php?page=rm_options_advance">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>rm_advance_options.png">
                    <div class="rm-settings-description">

                    </div>
                    <div class="rm-settings-subtitle"><?php _e("Advanced Options",'custom-registration-form-builder-with-submission-manager'); ?></div>
            ...
            <a href="admin.php?page=rm_form_sett_profilegrid&gs=1">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url(RM_IMG_URL); ?>profilegrid.png">
                    <div class="rm-settings-description">
            ...
            <a href="admin.php?page=rm_options_eventprime&gs=1">
                <div class="rm-settings-box">
                    <img class="rm-settings-icon" src="<?php echo esc_url($image_path); ?>event-prime-logo.png">
                    <div class="rm-settings-description">
