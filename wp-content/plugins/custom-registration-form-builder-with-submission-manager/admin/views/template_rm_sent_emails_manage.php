...
?>
<div class="rmagic">
<?php wp_enqueue_style('rm_jquery_ui_css', RM_BASE_URL . 'admin/css/jquery-ui.min.css'); ?>
...
<!-- mother form for all kind of searches.  It never shows but does it all.-->
            <form method="post" action="" name="rm_sent_emails_manage" id="rm_sent_emails_search_form">
                ...
                <input type="hidden" name="rm_interval" id="rm_interval_input_field" value="<?php echo esc_attr($data->filter->filters['rm_interval']); ?>" />
                <input type="hidden" name="rm_fromdate" id="rm_fromdate_input_field" value="<?php echo esc_attr($data->filter->filters['rm_fromdate']); ?>" />
                <input type="hidden" name="rm_dateupto" id="rm_uptodate_input_field" value="<?php echo esc_attr($data->filter->filters['rm_dateupto']); ?>" />
                <input type="hidden" name="rm_field_to_search" id="rm_field_to_search_input_field" value="<?php echo esc_attr($data->filter->filters['rm_field_to_search']); ?>" />
                <input type="hidden" name="rm_value_to_search" id="rm_value_to_search_input_field" value="<?php echo esc_attr($data->filter->filters['rm_value_to_search']); ?>" />
            ...
            <div class="sidebar">
                ...
                <div class="sb-filter">
                    <?php echo wp_kses_post(RM_UI_Strings::get("LABEL_MATCH_FIELD")); ?>
                        ...
                        <div class="filter-row"><input type="text" name="rm_value_to_search_dispf" class="sb-search" value="<?php echo esc_attr($data->filter->filters['rm_value_to_search']); ?>"></div>
...
<!--                            <th>&nbsp;</th>-->
                        ...
                        ?>
                                <tr>
                                    <td>
                                        <input class="rm_checkbox_group" type="checkbox" onclick="rm_on_sent_email_selection()"  value="<?php echo esc_attr($mail->mail_id); ?>" name="rm_selected[]">
                                    </td>
<!--                                    <td>
                                    ...
                                    <td class="rm_data">
                                        <?php
                                            echo esc_html($mail->to);
                                        ?>
                                    </td>
                                    <td class="rm_data">
                                        <?php
                                            echo esc_html(htmlspecialchars_decode($mail->sub));
                                        ?>
                                    </td>
                                    <td class="rm_data">
                                        <?php
