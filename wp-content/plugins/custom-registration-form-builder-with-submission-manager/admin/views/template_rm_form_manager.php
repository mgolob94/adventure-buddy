...
?>
    ...
    <div class="rm-side-banner">
        <div class="rm-sidebanner-image">
            <img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/rm-support-banner.svg'); ?>">
        </div>
        <div class="rm-sidebanner-mg-logo">
            <img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/mg-logo.png'); ?>">
        </div>
        <div class="sidebanner-content-wrapper">
            <div class="sidebanner-text-content">
             <div class="sidebanner-text"> <?php _e('Something not working?', 'custom-registration-form-builder-with-submission-manager'); ?></div>
             <div class="sidebanner-help-text"><?php _e('We want to help!', 'custom-registration-form-builder-with-submission-manager'); ?></div>
             <p><?php _e('If you face any issues with our plugin, or have questions, we\'re here to help!', 'custom-registration-form-builder-with-submission-manager'); ?></p>
           <!--<div class="rm-side-banner-help-text"><?php _e('Starter Guide', 'custom-registration-form-builder-with-submission-manager'); ?></div>--->
             <!--<div class="rm-side-banner-text"><?php _e('8 minutes read', 'custom-registration-form-builder-with-submission-manager'); ?></div>--->
           <!--<p><?php _e('Recommended read for quick and easy setup', 'custom-registration-form-builder-with-submission-manager'); ?></p>--->
            </div>
            <div class="rm-sidebanner-buttons">
		    
		 <!--<div class="rm-sidebanner-button">
                    <a target="_blank" href="https://registrationmagic.com/create-wordpress-registration-page-starter-guide/"><?php _e('Starter Guide', 'custom-registration-form-builder-with-submission-manager'); ?></a>			
                </div> -->
                ...
                <!--<div class="rm-sidebanner-button">
                 ...
                 <!--<<div class="rm-sidebanner-button">
                    <a target="_blank" href="https://wordpress.org/support/plugin/custom-registration-form-builder-with-submission-manager/#new-topic-0"> <?php _e('Create Support Request', 'custom-registration-form-builder-with-submission-manager'); ?></a>			
                </div>-->
                
                <div class="rm-sidebanner-button">
                    <a target="_blank" href="admin.php?page=rm_support_forum"> <?php _e('Help & Support', 'custom-registration-form-builder-with-submission-manager'); ?></a>			
                </div>
                
                <div class="rm-sidebanner-button">
                    <a target="_blank" href="https://metagauss.com/customization-help/"> <?php _e('Request Custom Solution ', 'custom-registration-form-builder-with-submission-manager'); ?></a>			
                </div>
                ...
                <!-- 
                 <div class="rm-sidebanner-button">
                    <a target="_blank" href="https://registrationmagic.com/translate-wordpress-plugins/"><?php _e('Translate', 'custom-registration-form-builder-with-submission-manager'); ?></a>
                </div> 
                -->
