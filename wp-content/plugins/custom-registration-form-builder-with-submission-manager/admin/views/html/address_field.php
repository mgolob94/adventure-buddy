...
<script>
    ...
    jQuery(document).ready(function(){
       var address_type= "<?php echo esc_html($address_type); ?>";  
       if(address_type=="ca")
       ...
       var ca_state_type= "<?php echo esc_html($ca_state_type); ?>";
       ...
       if("<?php echo esc_html($state_codes_enabled); ?>"==1){
    ...
    function rm_state_type_changed(type){
        jQuery("#rm_ca_state_" + type).prop('checked',true);
