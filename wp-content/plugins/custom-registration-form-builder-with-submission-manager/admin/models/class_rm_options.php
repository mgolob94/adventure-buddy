...
class RM_Options
{
    ...
    public function __construct()
    {
        ...
        $this->default['admin_order'] = array(
            array("rm_form_manage",__('Forms','custom-registration-form-builder-with-submission-manager'),array("administrator") ,"visible","false"),
            array("rm_options_manage",__('Settings','custom-registration-form-builder-with-submission-manager'),array("administrator") ,"visible","false"),
            ...
            array("rm_paypal_field_manage",__('Products','custom-registration-form-builder-with-submission-manager'),array("administrator") ,"visible","true"),
            ...
            array("rm_sent_emails_manage",__('Outbox','custom-registration-form-builder-with-submission-manager'),array("administrator") ,"visible","false"),
            ...
            array("rm_user_manage",__('Users','custom-registration-form-builder-with-submission-manager'),array("administrator") ,"visible","false"),
            ...
            array("rm_analytics_show_field",__('Fields Analytics','custom-registration-form-builder-with-submission-manager'),array("administrator") ,"visible","false"),
            array("rm_reports_dashboard",__('Reports','custom-registration-form-builder-with-submission-manager'),array("administrator") ,"visible","true"),
